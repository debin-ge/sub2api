  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_wiseQuickPayBaseUrlHint: 'Wise Quick Pay / payment link base URL. The system appends amount, currency, and description.',
        field_wiseApiBaseHint: 'Wise API base URL. Production usually uses https://api.wise.com.',
        field_wiseWebhookPublicKeyHint: 'Wise webhook RSA public key for X-Signature-SHA256 verification.',
        ...
        field_wiseAutoFulfillFeePaymentsHint: 'Must remain false in v1. Card, Apple Pay, and Google Pay fee cases require manual review.',
        ...
        wiseWebhookHint: 'Configure the webhook in Wise and subscribe to balance/account-details credit events.',
