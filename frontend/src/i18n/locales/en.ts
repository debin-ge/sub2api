...
const messages = {
  radar: {
    ...
    quota: {
      ...
      emptyNoPublishable: 'No publishable quota data. At least 2 supported subscription accounts on the same plan with recent passive quota snapshots are required.',
      ...
      trend: 'Trend',
      showTrendData: 'Show full trend data',
      hideTrendData: 'Hide full trend data',
    },
    trend: {
  ...
  legal: {
    ...
    retryLater: 'Please try again later or contact the administrator.',
    notFound: 'Document not found',
    notFoundDescription: 'This legal document does not exist or has not been published.',
    ...
    loginAgreementPrompt: {
      ...
      documentSeparator: ', ',
      noticeTitle: 'Login agreement confirmation required',
      noticeDescription: 'Please read and accept the related agreements before continuing.',
      viewTerms: 'View terms',
      dialogTitle: 'Confirm login agreement',
      dialogDescription: 'The agreement version was updated on {date}. Please review the related documents before continuing.',
      recently: 'recently',
      relatedDocuments: 'Related documents',
      reject: 'Decline',
      accept: 'Agree and continue',
      loginRejectedWarning: 'You must accept the login agreement before continuing to sign in.',
      loginRequiredWarning: 'Please confirm the login agreement first.',
      registerRejectedWarning: 'You must accept the login agreement before continuing to register.',
      registerRequiredWarning: 'Please confirm the login agreement first.',
    },
  },

  // Admin compliance acknowledgement
  adminCompliance: {
    title: 'Deployment and Operation Compliance Confirmation',
    blockingNotice: 'Compliance commitment confirmation is required',
    riskNotice: 'Before continuing to the admin console, please review and confirm the current Deployment and Operation Compliance Commitment.',
    version: 'Version',
    openDocument: 'Open source document',
    documentSource: 'This document comes from the compliance commitment file in the repository. Acknowledgements are stored per admin account.',
    inputLabel: 'Type the confirmation phrase exactly',
    inputPlaceholder: 'Enter the confirmation phrase to enable confirmation',
    inputMismatch: 'Enter the exact confirmation phrase shown above',
    legalNote: 'The system records the confirmed version, time, account identifier, IP address, and User-Agent for compliance audit trail.',
    logout: 'Log out',
    accept: 'Confirm and continue',
    accepted: 'Compliance commitment confirmed',
    acceptFailed: 'Confirmation failed. Please try again later.',
  },
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        enabledPaymentTypesHint: 'Disabling a payment method will also disable matching provider instances.',
        findProvider: 'View supported payment methods',
...
const missingMessages: Record<string, string> = {
  'admin.accounts.createSparkShadow': 'Create Spark shadow account',
  'admin.accounts.dataImportIgnoredFiles': 'Ignored {count} files',
  'admin.accounts.dataImportInvalidFile': 'Invalid file format',
  'admin.accounts.dataImportParseFailedFile': 'Failed to parse file',
  'admin.accounts.fromModel': 'Source model',
  'admin.accounts.gemini.oauthType.googleOneDesc': 'Google One / AI Pro account authorization',
  'admin.accounts.grokAccount': 'Grok account',
  'admin.accounts.headerOverride.addRow': 'Add header',
  'admin.accounts.headerOverride.bulkDisableHint': 'Submit with no rows to disable custom headers in bulk.',
  'admin.accounts.headerOverride.bulkEmptyRows': 'Add at least one header override.',
  'admin.accounts.headerOverride.bulkReplaceHint': 'Bulk edit replaces the current header override configuration on selected accounts.',
  'admin.accounts.headerOverride.emptyValueHint': 'An empty value sends an empty string; deleting the row stops overriding that header.',
  'admin.accounts.headerOverride.fillTemplate': 'Fill example',
  'admin.accounts.headerOverride.hint': 'Append or override HTTP headers when forwarding requests through this account.',
  'admin.accounts.headerOverride.info': 'Header names are case-insensitive. Later duplicate rows take precedence.',
  'admin.accounts.headerOverride.namePlaceholder': 'e.g. Authorization',
  'admin.accounts.headerOverride.title': 'Header overrides',
  'admin.accounts.headerOverride.valuePlaceholder': 'Header value',
  'admin.accounts.oauth.openai.accessTokenAuth': 'Access token auth',
  'admin.accounts.oauth.openai.codexPatAuth': 'Codex PAT auth',
  'admin.accounts.oauth.openai.codexPatDesc': 'Import Codex Personal Access Tokens for Codex-related requests.',
  'admin.accounts.oauth.openai.codexPatHint': 'One PAT per line. Batch import creates one account per token.',
  'admin.accounts.oauth.openai.codexPatImportAndCreate': 'Import PAT and create accounts',
  'admin.accounts.oauth.openai.codexPatInputLabel': 'Codex PAT',
  'admin.accounts.oauth.openai.codexPatPlaceholder': 'Paste Codex PATs, one per line',
  'admin.accounts.oauth.openai.mobileRefreshTokenAuth': 'Mobile refresh token auth',
  'admin.accounts.openai.codexCLIOnlyAppServer': 'Only allow Codex CLI / App Server clients',
  'admin.accounts.openai.codexCLIOnlyAppServerDesc': 'When enabled, only requests matching Codex CLI or App Server fingerprints are accepted.',
  'admin.accounts.openai.wsModeHttpBridge': 'HTTP bridge mode',
  'admin.accounts.openaiQuotaReset.collapseExpirations': 'Collapse reset-credit expirations',
  'admin.accounts.openaiQuotaReset.confirmMessage': 'Consume 1 reset credit? {count} credits are currently available.',
  'admin.accounts.openaiQuotaReset.confirmTitle': 'Confirm OpenAI quota reset',
  'admin.accounts.openaiQuotaReset.count': 'Credits',
  'admin.accounts.openaiQuotaReset.countTooltipLoad': 'Query available reset credits',
  'admin.accounts.openaiQuotaReset.countTooltipRefresh': 'Refresh available reset credits',
  'admin.accounts.openaiQuotaReset.expandExpirations': 'Show {count} expiration times',
  'admin.accounts.openaiQuotaReset.expirationDetails': 'Reset-credit expiration details',
  'admin.accounts.openaiQuotaReset.expiresAt': 'Expires {time}',
  'admin.accounts.openaiQuotaReset.expiresAtFull': 'Expires at: {time}',
  'admin.accounts.openaiQuotaReset.noCreditsAvailable': 'No reset credits available',
  'admin.accounts.openaiQuotaReset.reset': 'Reset',
  'admin.accounts.openaiQuotaReset.resetSuccess': 'Reset quota windows: {windows}',
  'admin.accounts.openaiQuotaReset.resetTooltipNeedQuery': 'Query available reset credits first',
  'admin.accounts.openaiQuotaReset.resetTooltipNoCredits': 'No reset credits available',
  'admin.accounts.openaiQuotaReset.resetTooltipReady': 'Consume 1 reset credit',
  'admin.accounts.openaiQuotaReset.resetTooltipShadow': 'Shadow accounts cannot be reset directly. Reset the parent account instead.',
  'admin.accounts.toModel': 'Target model',
  'admin.accounts.usageWindow.grokLastHeadersSeen': 'Last headers seen',
  'admin.accounts.usageWindow.grokLastProbe': 'Last probe',
  'admin.accounts.usageWindow.grokLastStatus': 'Last status',
  'admin.accounts.usageWindow.grokNoHeaders': 'No Grok quota headers detected',
  'admin.accounts.usageWindow.grokProbe': 'Probe Grok quota',
  'admin.accounts.usageWindow.grokProbeTooltip': 'Send a lightweight probe request to refresh Grok quota headers.',
  'admin.accounts.usageWindow.grokRequests': 'Grok requests',
  'admin.accounts.usageWindow.grokResetUnsupported': 'Reset unsupported',
  'admin.accounts.usageWindow.grokResetUnsupportedTooltip': 'Grok quota windows cannot currently be reset from the console.',
  'admin.accounts.usageWindow.grokRetryAfter': 'Retry-After',
  'admin.accounts.usageWindow.grokTokens': 'Grok tokens',
  'admin.accounts.usageWindow.grokUnknown': 'Grok quota unknown',
  'admin.channelMonitor.form.jitterSeconds': 'Jitter seconds',
  'admin.channelMonitor.form.jitterSecondsHint': 'Add random jitter to monitor scheduling to avoid clustered requests.',
  'admin.channels.emptyModelsInPricing': 'Configure at least one model price.',
  'admin.channels.form.cacheReadPriceShort': 'Cache read',
  'admin.channels.form.cacheWritePriceShort': 'Cache write',
  'admin.channels.form.inclusive': 'Inclusive',
  'admin.channels.form.maxTokens': 'Max tokens',
  'admin.channels.form.minTokens': 'Min tokens',
  'admin.channels.noGroupsSelected': 'Select at least one group.',
  'admin.groups.failedToSave': 'Failed to save',
  'admin.groups.rateLabel': 'Rate',
  'admin.ops.customTimeRange.endTime': 'End time',
  'admin.ops.customTimeRange.startTime': 'Start time',
  'admin.ops.errorLog.ip': 'IP',
  'admin.ops.result': 'Result',
  'admin.ops.runtime.metricThresholds': 'Metric thresholds',
  'admin.ops.runtime.metricThresholdsHint': 'Configure thresholds used for runtime health scoring and alert highlighting.',
  'admin.ops.runtime.requestErrorRateMaxPercent': 'Request error rate max (%)',
  'admin.ops.runtime.requestErrorRateMaxPercentHint': 'Request error rate is marked unhealthy when it exceeds this percentage.',
  'admin.ops.runtime.slaMinPercent': 'SLA minimum percent',
  'admin.ops.runtime.slaMinPercentHint': 'SLA is marked unhealthy when it falls below this value.',
  'admin.ops.runtime.ttftP99MaxMs': 'TTFT P99 max (ms)',
  'admin.ops.runtime.ttftP99MaxMsHint': 'First-token latency is marked unhealthy when P99 exceeds this value.',
  'admin.ops.runtime.upstreamErrorRateMaxPercent': 'Upstream error rate max (%)',
  'admin.ops.runtime.upstreamErrorRateMaxPercentHint': 'Upstream error rate is marked unhealthy when it exceeds this percentage.',
  'admin.ops.systemLogs.all': 'All',
  'admin.ops.systemLogs.caller': 'Record caller',
  'admin.ops.systemLogs.cleanCurrentFilters': 'Clean current filters',
  'admin.ops.systemLogs.cleanupConfirm': 'Clean system logs matching the current filters?',
  'admin.ops.systemLogs.cleanupFailed': 'Failed to clean system logs',
  'admin.ops.systemLogs.cleanupSuccess': 'System logs cleaned',
  'admin.ops.systemLogs.component': 'Component',
  'admin.ops.systemLogs.componentPlaceholder': 'e.g. gateway',
  'admin.ops.systemLogs.description': 'View system runtime logs, write health, and runtime logging configuration.',
  'admin.ops.systemLogs.dropped': 'Dropped',
  'admin.ops.systemLogs.empty': 'No system logs',
  'admin.ops.systemLogs.endTime': 'End time',
  'admin.ops.systemLogs.failed': 'Failed',
  'admin.ops.systemLogs.keyId': 'Key ID',
  'admin.ops.systemLogs.keyword': 'Keyword',
  'admin.ops.systemLogs.keywordPlaceholder': 'Search message, error, or request ID',
  'admin.ops.systemLogs.latestWriteError': 'Latest write error: ',
  'admin.ops.systemLogs.level': 'Level',
  'admin.ops.systemLogs.loadFailed': 'Failed to load system logs',
  'admin.ops.systemLogs.logDetails': 'Log details',
  'admin.ops.systemLogs.model': 'Model',
  'admin.ops.systemLogs.platform': 'Platform',
  'admin.ops.systemLogs.queue': 'Queue',
  'admin.ops.systemLogs.refreshHealth': 'Refresh health',
  'admin.ops.systemLogs.resetDefaults': 'Reset defaults',
  'admin.ops.systemLogs.resetRuntimeConfigConfirm': 'Reset system log runtime configuration to defaults?',
  'admin.ops.systemLogs.retentionDays': 'Retention days',
  'admin.ops.systemLogs.runtimeConfig': 'Runtime config',
  'admin.ops.systemLogs.runtimeConfigActive': 'System log runtime config is active',
  'admin.ops.systemLogs.runtimeConfigReset': 'System log runtime config reset to defaults',
  'admin.ops.systemLogs.runtimeConfigResetFailed': 'Failed to reset system log runtime config',
  'admin.ops.systemLogs.runtimeConfigSaveFailed': 'Failed to save system log runtime config',
  'admin.ops.systemLogs.sampling': 'Enable sampling',
  'admin.ops.systemLogs.samplingInitial': 'Initial entries',
  'admin.ops.systemLogs.samplingThereafter': 'Sample every N after',
  'admin.ops.systemLogs.saveAndApply': 'Save and apply',
  'admin.ops.systemLogs.search': 'Search logs',
  'admin.ops.systemLogs.stacktraceThreshold': 'Stacktrace threshold',
  'admin.ops.systemLogs.startTime': 'Start time',
  'admin.ops.systemLogs.time': 'Time',
  'admin.ops.systemLogs.timeRange': 'Time range',
  'admin.ops.systemLogs.title': 'System logs',
  'admin.ops.systemLogs.written': 'Written',
  'admin.ops.timeRange.custom': 'Custom',
  'admin.riskControl.action.cyberPolicy': 'Cyber policy',
  'admin.riskControl.cyberPolicyExcludeBan': 'Exclude ban',
  'admin.riskControl.cyberPolicyExcludeBanHint': 'When enabled, Cyber policy matches will not trigger ban actions.',
  'admin.riskControl.defaultBlockMessage': 'The request was blocked by risk control policy.',
  'admin.riskControl.matchedKeyword': 'Matched keyword',
  'admin.riskControl.violationNotCounted': 'Not counted as violation',
  'admin.settings.features.riskControl.cyberSessionBlock': 'Cyber session block',
  'admin.settings.features.riskControl.cyberSessionBlockHint': 'Block repeated Cyber risk hits by session.',
  'admin.settings.features.riskControl.cyberSessionBlockTTL': 'Cyber session block TTL',
  'admin.settings.gatewayForwarding.addSystemBlock': 'Add system block',
  'admin.settings.gatewayForwarding.cacheTTL1h': '1 hour',
  'admin.settings.gatewayForwarding.cacheTTL5m': '5 minutes',
  'admin.settings.gatewayForwarding.claudeOAuthSystemPromptBlocks': 'Claude OAuth system prompt blocks',
  'admin.settings.gatewayForwarding.claudeOAuthSystemPromptBlocksHint': 'Inject ordered system prompt blocks into Claude OAuth requests and control cache behavior per block.',
  'admin.settings.gatewayForwarding.claudeOAuthSystemPromptInjection': 'Claude OAuth system prompt injection',
  'admin.settings.gatewayForwarding.claudeOAuthSystemPromptInjectionHint': 'Automatically inject extra system prompts into Claude OAuth requests.',
  'admin.settings.gatewayForwarding.clientDatelineNormalization': 'Client dateline normalization',
  'admin.settings.gatewayForwarding.clientDatelineNormalizationHint': 'Normalize client dateline information to reduce upstream issues caused by timezone/date differences.',
  'admin.settings.gatewayForwarding.codexAddRow': 'Add rule',
  'admin.settings.gatewayForwarding.codexAllowAppServer': 'Allow App Server clients',
  'admin.settings.gatewayForwarding.codexAllowAppServerDesc': 'In Codex CLI restriction mode, also allow clients matching App Server fingerprints.',
  'admin.settings.gatewayForwarding.codexBlacklist': 'Codex blacklist',
  'admin.settings.gatewayForwarding.codexBlacklistDesc': 'Requests matching Originator or User-Agent rules are rejected.',
  'admin.settings.gatewayForwarding.codexClientRestrictionTitle': 'Client restrictions',
  'admin.settings.gatewayForwarding.codexFingerprintNoRequiredWarn': 'At least one required fingerprint signal is recommended.',
  'admin.settings.gatewayForwarding.codexFingerprintSignals': 'Codex fingerprint signals',
  'admin.settings.gatewayForwarding.codexFingerprintSignalsDesc': 'Configure headers or body paths used to identify Codex clients.',
  'admin.settings.gatewayForwarding.codexFpMatchPlaceholder': 'Match value or path',
  'admin.settings.gatewayForwarding.codexFpRequired': 'Required',
  'admin.settings.gatewayForwarding.codexFpTypeBodyPath': 'Body path',
  'admin.settings.gatewayForwarding.codexFpTypeHeaderExact': 'Header exact',
  'admin.settings.gatewayForwarding.codexFpTypeHeaderPrefix': 'Header prefix',
  'admin.settings.gatewayForwarding.codexHardeningDesc': 'Restrict Codex client versions, fingerprints, and origins to reduce abnormal client risk.',
  'admin.settings.gatewayForwarding.codexHardeningTitle': 'Codex hardening',
  'admin.settings.gatewayForwarding.codexOriginatorPlaceholder': 'Originator',
  'admin.settings.gatewayForwarding.codexRemoveRow': 'Remove',
  'admin.settings.gatewayForwarding.codexUaContainsPlaceholder': 'User-Agent contains',
  'admin.settings.gatewayForwarding.codexVersionHint': 'Leave blank to disable that version boundary.',
  'admin.settings.gatewayForwarding.codexWhitelist': 'Codex whitelist',
  'admin.settings.gatewayForwarding.codexWhitelistDesc': 'Requests matching whitelist rules can be explicitly allowed.',
  'admin.settings.gatewayForwarding.codexWhitelistSkipFingerprint': 'Skip fingerprint',
  'admin.settings.gatewayForwarding.codexWhitelistSkipFingerprintTooltip': 'Skip Codex fingerprint checks when this whitelist rule matches.',
  'admin.settings.gatewayForwarding.maxCodexVersion': 'Maximum Codex version',
  'admin.settings.gatewayForwarding.maxCodexVersionPlaceholder': 'e.g. 0.35.0',
  'admin.settings.gatewayForwarding.minCodexVersion': 'Minimum Codex version',
  'admin.settings.gatewayForwarding.minCodexVersionPlaceholder': 'e.g. 0.20.0',
  'admin.settings.gatewayForwarding.resetSystemBlocks': 'Reset system blocks',
  'admin.settings.gatewayForwarding.systemBlockCacheControl': 'Enable cache control',
  'admin.settings.gatewayForwarding.systemBlockHide': 'Collapse',
  'admin.settings.gatewayForwarding.systemBlockPreset': 'Preset',
  'admin.settings.gatewayForwarding.systemBlockPresetBilling': 'Billing note',
  'admin.settings.gatewayForwarding.systemBlockPresetCustom': 'Custom',
  'admin.settings.gatewayForwarding.systemBlockPresetExpansion': 'Capability expansion',
  'admin.settings.gatewayForwarding.systemBlockPresetIdentity': 'Identity note',
  'admin.settings.gatewayForwarding.systemBlockShow': 'Expand',
  'admin.settings.gatewayForwarding.systemBlockText': 'Prompt text',
  'admin.settings.gatewayForwarding.systemBlockTitle': 'System block #{index}',
  'admin.settings.gatewayForwarding.systemBlockType': 'Type',
  'admin.settings.gatewayForwarding.systemBlockTypeText': 'Text',
  'admin.settings.openaiExperimentalScheduler.defaultPlaceholder': 'Default: {value}',
  'admin.settings.openaiExperimentalScheduler.errorRateWeight': 'Error rate weight',
  'admin.settings.openaiExperimentalScheduler.loadWeight': 'Load weight',
  'admin.settings.openaiExperimentalScheduler.previousResponseWeight': 'Previous response weight',
  'admin.settings.openaiExperimentalScheduler.priorityWeight': 'Priority weight',
  'admin.settings.openaiExperimentalScheduler.queueWeight': 'Queue weight',
  'admin.settings.openaiExperimentalScheduler.quotaHeadroomWeight': 'Quota headroom weight',
  'admin.settings.openaiExperimentalScheduler.resetWeight': 'Reset weight',
  'admin.settings.openaiExperimentalScheduler.sessionStickyWeight': 'Session sticky weight',
  'admin.settings.openaiExperimentalScheduler.stickyWeightedDescription': 'Select upstream accounts using account load, error rate, latency, and session stickiness.',
  'admin.settings.openaiExperimentalScheduler.stickyWeightedTitle': 'Enable sticky weighted scheduling',
  'admin.settings.openaiExperimentalScheduler.subscriptionPriorityDescription': 'Subscription priority participates in account scheduling score.',
  'admin.settings.openaiExperimentalScheduler.subscriptionPriorityTitle': 'Subscription priority',
  'admin.settings.openaiExperimentalScheduler.topKLabel': 'Candidate Top K',
  'admin.settings.openaiExperimentalScheduler.ttftWeight': 'TTFT weight',
  'admin.settings.openaiExperimentalScheduler.weightsDescription': 'Tune each factor used in the scheduling score.',
  'admin.settings.openaiExperimentalScheduler.weightsTitle': 'Scheduling weights',
  'admin.settings.payment.addCustomMethod': 'Add custom method',
  'admin.settings.payment.customMethodDisplayName': 'Display name',
  'admin.settings.payment.customMethodType': 'Method key',
  'admin.settings.payment.customMethodUpstreamType': 'Upstream method',
  'admin.settings.payment.easypayCustomMethods': 'EasyPay custom methods',
  'admin.settings.payment.easypayCustomMethodsHint': 'Map custom payment types returned by EasyPay.',
  'admin.settings.payment.subscriptionUsdToCnyRate': 'Subscription USD to CNY rate',
  'admin.settings.payment.subscriptionUsdToCnyRateDisabled': 'This rate is not used when CNY subscription payments are disabled.',
  'admin.settings.payment.subscriptionUsdToCnyRateHint': 'Used to convert subscription plan USD prices to CNY payment amounts.',
  'admin.settings.payment.validationEasyPayCustomMethodDuplicate': 'Custom payment methods cannot be duplicated.',
  'admin.settings.payment.validationEasyPayCustomMethodPrefixReserved': 'Custom payment method cannot use a reserved prefix.',
  'admin.settings.payment.validationEasyPayCustomMethodRequired': 'Enter a custom payment method.',
  'admin.settings.payment.validationEasyPayCustomMethodReserved': 'This payment method is reserved by the system.',
  'admin.settings.payment.validationEasyPayCustomMethodTypeInvalid': 'Payment method key format is invalid.',
  'admin.settings.payment.validationEasyPayCustomMethodUpstreamTypeInvalid': 'Upstream payment method format is invalid.',
  'admin.subscriptions.failedToRestore': 'Failed to restore subscription',
  'admin.subscriptions.restore': 'Restore',
  'admin.subscriptions.restoreConfirm': 'Restore this subscription?',
  'admin.subscriptions.restoreSubscription': 'Restore subscription',
  'admin.subscriptions.subscriptionRestored': 'Subscription restored',
  'admin.users.allApiKeyGroups': 'All API key groups',
  'admin.users.allAuthorizedGroups': 'All authorized groups',
  'admin.users.apiKeyGroupDisabled': 'Disabled',
  'admin.users.apiKeyGroupExclusive': 'Exclusive',
  'admin.users.apiKeyGroupFilter': 'API key group filter',
  'admin.users.apiKeyGroupPublic': 'Public',
  'admin.users.apiKeyGroupSubscription': 'Subscription',
  'admin.users.authorizedGroupFilter': 'Authorized group filter',
  'admin.users.passwordCopied': 'Password copied',
  'admin.users.searchApiKeyGroups': 'Search API key groups',
  'admin.users.searchAuthorizedGroups': 'Search authorized groups',
  'auth.dingtalkProviderName': 'DingTalk',
  'common.apply': 'Apply',
  'common.clear': 'Clear',
  'common.creating': 'Creating...',
  'common.login': 'Log in',
  'common.peakRateImageNote': '; image pricing follows image billing rules',
  'common.peakRateTooltip': 'Peak rate window: {window}',
  'common.required': 'Required',
  'common.sending': 'Sending...',
  'common.tryAgain': 'Try again',
  'customPage.copiedCode': 'Code copied',
  'customPage.copyCode': 'Copy code',
  'customPage.copyCodeFailed': 'Failed to copy code',
  'customPage.tableOfContents': 'Table of contents',
  'keys.columnSettings': 'Column settings',
  'keys.currentConcurrency': 'Current concurrency',
  'payment.admin.queryRefundStatus': 'Query refund status',
  'payment.admin.refundPending': 'Refund pending',
  'payment.admin.subscriptionCnyPayPreview': 'CNY payment preview: ¥{amount}',
  'payment.admin.subscriptionCnyPayPreviewWithFee': 'Preview with fee: ¥{amount}',
  'payment.planCard.peakRate': 'Peak rate {rate}x',
  'payment.status.refund_pending': 'Refund pending',
  'usage.cacheBreakdown': 'Cache breakdown',
  'usage.cacheCreationTokensLabel': 'Cache creation tokens',
  'usage.cacheReadTokensLabel': 'Cache read tokens',
  'usage.cacheTotal': 'Cache total',
  'usage.cyber': 'Cyber',
  'usage.errors.allStatuses': 'All statuses',
  'usage.ipGeo.batchFailed': 'Failed to batch fetch regions',
  'usage.ipGeo.batchFetch': 'Batch fetch regions',
  'usage.ipGeo.batchFetching': 'Batch fetching...',
  'usage.ipGeo.detailAccuracy': 'Accuracy',
  'usage.ipGeo.detailCoordinates': 'Coordinates',
  'usage.ipGeo.detailOrg': 'Organization',
  ...
  'usage.ipGeo.refreshTitle': 'Refresh IP region',
}

function applyMissingLocaleMessages(target: LocaleMessageTree, patches: Record<string, string>): void {
  for (const [path, value] of Object.entries(patches)) {
    ...
    for (const part of parts.slice(0, -1)) {
      ...
      if (!next || typeof next !== 'object') {
        ...
        current = next as LocaleMessageTree
      }
    }
...
applyMissingLocaleMessages(messages as LocaleMessageTree, missingMessages)
