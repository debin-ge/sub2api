export default {
  ...
  benchmark: {
    ...
    public: {
      home: {
        ...
        description: 'Compare public benchmark ability scores while keeping latency, success rate, token usage, and cost as independent runtime metrics.',
        loadingTitle: 'Loading radar data',
        loadingDescription: 'Fetching the latest published ranking.',
        errorTitle: 'Unable to load radar data',
        loadError: 'Failed to load public radar data.',
      },
      empty: {
        title: 'No radar data yet',
        description: 'Published benchmark rankings will appear here once a public snapshot is available.',
      },
      summary: {
        targetsLabel: 'Tracked Targets',
        targetsCaption: 'Publicly visible combinations',
        averageScoreLabel: 'Average Ability Score',
        averageScoreCaption: 'Represents task ability only',
        sampleStatusLabel: 'Sample Status',
        sampleStatusCaption: 'Targets with sufficient scored samples',
        passedLabel: 'Passed Tasks',
        passedCaption: 'Total passed / total across all models',
        latestRunLabel: 'Latest Run',
        latestRunEmptyCaption: 'No completed run yet',
      },
      dimension: {
        title: 'Ability Dimensions',
        description: 'Average dimension scores across the published results.',
        empty: 'No dimension data',
      },
      trend: {
        title: 'Trends',
        description: 'Ability score trends across recent runs.',
      },
      table: {
        rank: 'Rank',
        model: 'Model',
    ...
    admin: {
      dashboard: {
        ...
        waitingPublish: 'Waiting for publish',
        noPublicSnapshot: 'No public snapshot yet',
        targets: 'Targets',
        tasks: 'Tasks',
        profiles: 'Profiles',
        schedules: 'Schedules',
      ...
      targets: {
        title: 'Targets',
        description: 'Manage model and channel snapshots that participate in benchmark runs.',
        refresh: 'Refresh',
        create: 'Create Target',
        edit: 'Edit',
        update: 'Update Target',
        loadError: 'Failed to load targets',
        createError: 'Failed to create target',
        createSuccess: 'Target created',
        updateError: 'Failed to update target',
        updateSuccess: 'Target updated',
        deleteError: 'Failed to delete target',
        deleteSuccess: 'Target deleted',
        deleteConfirm: 'Are you sure you want to delete this target? This cannot be undone.',
        jsonError: 'Metadata must be a valid JSON object.',
        selectChannel: 'Select runnable channel',
        channelLoading: 'Loading channels',
        channelLoadError: 'Failed to load channels',
        channelHint: 'Radar tests send model requests through the selected channel.',
        channelReady: 'This channel has an OpenAI group and can run radar tests.',
        channelRequired: 'Select a channel that has an OpenAI group.',
        noRunnableChannels: 'No runnable channels',
        noRunnableChannelsHint: 'Create an active channel with an OpenAI group in channel management first.',
        channelNoGroups: 'No groups linked',
        channelNoOpenAIGroup: 'No OpenAI group linked',
        groupLoadError: 'Failed to load groups',
        modelLoadError: 'Failed to load models',
        selectGroup: 'Select group',
        groupLoading: 'Loading groups',
        noGroups: 'No groups available',
        groupHint: 'Choose subscription or group first, then pick a group.',
        groupReady: 'This group can run standard radar tests.',
        groupRequired: 'Select an OpenAI group and model.',
        groupUnsupportedPlatform: 'This group uses {platform}; standard radar execution currently supports OpenAI groups only.',
        ...
        emptyDescription: 'Created model targets will appear here.',
        fields: {
          sourceType: 'Source',
          group: 'Group',
          ...
          channelSnapshot: 'Channel Name Snapshot',
          channelSnapshotHint: 'Generated after selecting a channel',
          supportedTaskTypes: 'Supported Task Types',
          maxConcurrency: 'Max Concurrency',
          perRunBudget: 'Per-run Budget',
      ...
      tasks: {
        ...
        fields: {
          ...
          verifier: 'Verifier',
          verifierConfig: 'Verifier Config JSON',
          weight: 'Weight',
      ...
      profiles: {
        title: 'Profiles',
        description: 'Manage evaluation targets, task types, and sampling scale.',
        refresh: 'Refresh',
        createTitle: 'Create Profile',
        createDescription: 'Pick targets, task types, and a run scale.',
        previewTitle: 'Profile Preview',
        previewDescription: 'Preview the sample size after adjusting filters on an existing profile.',
        ...
        previewError: 'Failed to preview profile',
        jsonError: '{field} must be valid JSON object',
        ...
        fields: {
          ...
          profile: 'Profile',
          taskCountLimit: 'Task Count Limit',
          perTypeLimit: 'Per-Type Limit JSON',
          ...
          scoringConfig: 'Scoring Config JSON',
          enabled: 'Enabled',
          metadata: 'Metadata JSON',
        },
        previewCards: {
          ...
          selectedTargets: 'Selected Target IDs',
        },
        rankingBasis: {
          abilityScoreOnly: 'Ability score only',
        },
        validation: {
          suiteId: 'Suite ID must be greater than 0',
        },
        columns: {
          name: 'Name',
          targets: 'Targets',
        ...
        emptyDescription: 'Your first benchmark profile will appear here.',
      },
      runs: {
        title: 'Runs',
        ...
        processError: 'Failed to process run',
        processDueError: 'Failed to process due tasks',
        createSuccess: 'Run #{id} created',
        cancelSuccess: 'Run canceled',
        processSuccess: 'Processed {count} task(s)',
        processDueSuccess: 'Processed {count} due task(s)',
        noTargets: 'No targets yet.',
      ...
      schedules: {
        ...
        triggerSuccess: 'Schedule triggered, Run #{id} created',
        triggerError: 'Failed to trigger schedule',
        noTargets: 'No targets yet.',
        emptyTitle: 'No schedules yet',
        emptyDescription: 'Create the first benchmark schedule.',
        fields: {
          name: 'Name',
        ...
        validation: {
          required: 'Name and Cron Expression are required',
        },
        columns: {
          name: 'Name',
          cronExpr: 'Cron',
      ...
      runDetail: {
        title: 'Run Detail',
        defaultDescription: 'Inspect the results and snapshots for a single run.',
        runStatus: 'Run #{id} / {status}',
        runId: 'Run ID',
        loadManual: 'Load',
        refresh: 'Refresh',
        process: 'Process',
        cancel: 'Cancel',
        publish: 'Publish Public Snapshot',
        publishSuccess: 'Public snapshot published',
        publishError: 'Failed to publish public snapshot',
        processSuccess: 'Processed {count} processing step(s)',
        processError: 'Failed to process run',
        cancelSuccess: 'Run canceled',
        cancelError: 'Failed to cancel run',
        loadError: 'Failed to load run detail',
        emptySelectTitle: 'Select a run',
        emptySelectDescription: 'Open the detail page directly with a run id once routing is wired in.',
        ...
        noInvalidReasons: 'No invalid reasons.',
        noInvalidReasonsShort: 'None',
        targetResultsTitle: 'Per-Target Result Details',
        targetResultsCount: '{count} results',
        noTargetResults: 'No target results.',
        insufficientSample: 'Insufficient Sample',
        overview: {
          status: 'Status',
        ...
        columns: {
          ...
          invalidReasons: 'Invalid Reasons',
          successRate: 'Success Rate',
          p50p95: 'P50 / P95',
          token: 'Token',
          cost: 'Cost',
  ...
  nav: {
    ...
    benchmarkDashboard: 'Radar Overview',
    benchmarkTargets: 'Targets',
    benchmarkTasks: 'Tasks',
    benchmarkProfiles: 'Profiles',
  ...
  admin: {
    ...
    settings: {
      ...
      features: {
        ...
        benchmark: {
          title: 'Model Radar',
          description: 'Manage runtime, public exposure, and homepage integration for the benchmark/radar subsystem.',
          configureLink: 'Open Model Radar > Radar Overview',
          enabled: 'Enable Benchmark',
          enabledHint: 'Disabling blocks new benchmark runs while keeping history and admin pages available.',
          publicEnabled: 'Enable Public Radar',
          publicEnabledHint: 'When off, the public radar endpoint returns a stable empty structure and the homepage will not show published snapshots.',
          homeEnabled: 'Enable Radar Home',
          homeEnabledHint: 'Only applies when home_content is empty; uses the public radar as the default homepage content.',
          scheduleEnabled: 'Enable Schedule',
          scheduleEnabledHint: 'When off, benchmark schedules do not auto-trigger.',
          defaultSuite: 'Default Suite ID',
          defaultSuiteHint: 'Pre-filled suite id for benchmark profile creation. Use 0 for no default suite.',
          globalConcurrency: 'Global Concurrency',
          globalConcurrencyHint: 'Fallback concurrency when a profile or run does not override it.',
          defaultTimeoutSeconds: 'Default Timeout (seconds)',
          defaultTimeoutSecondsHint: 'Fallback per-task timeout when a profile or run does not override it.',
          lowConfidenceThreshold: 'Low Confidence Threshold',
          lowConfidenceThresholdHint: 'Coverage below this threshold is marked as low / insufficient sample.',
          highConfidenceThreshold: 'High Confidence Threshold',
          highConfidenceThresholdHint: 'Coverage at or above this threshold is marked as high.',
        },
        availableChannels: {
          title: 'Available Channels',
