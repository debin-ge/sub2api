...
const messages = {
  radar: {
    ...
    quota: {
      ...
      emptyNoPublishable: '暂无可公开的额度数据。需要同一套餐下至少 2 个受支持的订阅账号，并且账号具有近期被动额度快照。',
      ...
      trend: '趋势',
      showTrendData: '查看完整趋势数据',
      hideTrendData: '收起完整趋势数据',
    },
    trend: {
      loading: '趋势数据加载中',
      error: '趋势数据加载失败',
  ...
  legal: {
    loadFailed: '文档加载失败',
    retryLater: '请稍后重试或联系管理员。',
    notFound: '文档不存在',
    notFoundDescription: '该法律文档不存在或暂未发布。',
    loginAgreement: '登录协议',
    ...
    loginAgreementPrompt: {
      ...
      documentSeparator: '、',
      noticeTitle: '需要确认登录协议',
      noticeDescription: '继续登录或注册前，请阅读并确认相关协议。',
      viewTerms: '查看协议',
      dialogTitle: '登录协议确认',
      dialogDescription: '协议版本更新于 {date}。请阅读相关文档后继续。',
      recently: '最近',
      relatedDocuments: '相关文档',
      reject: '暂不同意',
      accept: '同意并继续',
      loginRejectedWarning: '需要同意登录协议后才能继续登录。',
      loginRequiredWarning: '请先确认登录协议。',
      registerRejectedWarning: '需要同意登录协议后才能继续注册。',
      registerRequiredWarning: '请先确认登录协议。',
    },
  },
  ...
  adminCompliance: {
    title: '部署与运营合规确认',
    blockingNotice: '请先完成合规承诺确认',
    riskNotice: '继续使用管理控制台前，请阅读并确认当前版本的部署与运营合规承诺。',
    version: '版本',
    openDocument: '查看原始文档',
    documentSource: '文档来源于仓库中的合规承诺文件，确认记录按管理员账号单独保存。',
    inputLabel: '请逐字输入以下确认语',
    inputPlaceholder: '输入确认语以启用确认按钮',
    inputMismatch: '请输入与上方完全一致的确认语',
    legalNote: '系统会记录确认版本、时间、账号标识、IP 地址和 User-Agent，用于合规留痕。',
    logout: '退出登录',
    accept: '确认并继续',
    accepted: '合规承诺已确认',
    acceptFailed: '确认失败，请稍后重试',
  },
  ...
  admin: {
    ...
    accounts: {
      ...
      grok: {
        baseUrlHint: 'Grok OAuth 账号将转发到官方 xAI API Base URL。',
        apiKeyHint: 'Grok 订阅账号使用 OAuth Refresh Token；该账号类型不支持 API Key 创建。'
      },
	      glm: {
    ...
    settings: {
      ...
      payment: {
        ...
        enabledPaymentTypesHint: '禁用支付方式将同时禁用对应的服务商实例。',
        findProvider: '查看支持的支付方式',
        minAmount: '最低金额',
        maxAmount: '最高金额',
        dailyLimit: '每日限额',
...
const missingMessages: Record<string, string> = {
  'admin.accounts.createSparkShadow': '创建 Spark 影子账号',
  'admin.accounts.dataImportIgnoredFiles': '已忽略 {count} 个文件',
  'admin.accounts.dataImportInvalidFile': '文件格式不正确',
  'admin.accounts.dataImportParseFailedFile': '文件解析失败',
  'admin.accounts.fromModel': '源模型',
  'admin.accounts.gemini.oauthType.googleOneDesc': 'Google One / AI Pro 账号授权',
  'admin.accounts.grokAccount': 'Grok 账号',
  'admin.accounts.headerOverride.addRow': '添加请求头',
  'admin.accounts.headerOverride.bulkDisableHint': '留空并提交可批量禁用自定义请求头。',
  'admin.accounts.headerOverride.bulkEmptyRows': '请至少添加一个请求头覆盖项。',
  'admin.accounts.headerOverride.bulkReplaceHint': '批量编辑会替换所选账号当前的请求头覆盖配置。',
  'admin.accounts.headerOverride.emptyValueHint': '值留空表示发送空字符串；删除行表示不覆盖该请求头。',
  'admin.accounts.headerOverride.fillTemplate': '填入示例',
  'admin.accounts.headerOverride.hint': '为该账号转发请求时附加或覆盖指定 HTTP Header。',
  'admin.accounts.headerOverride.info': '请求头名称不区分大小写，重复名称会以后面的配置为准。',
  'admin.accounts.headerOverride.namePlaceholder': '例如 Authorization',
  'admin.accounts.headerOverride.title': '请求头覆盖',
  'admin.accounts.headerOverride.valuePlaceholder': '请求头值',
  'admin.accounts.oauth.openai.accessTokenAuth': 'Access Token 授权',
  'admin.accounts.oauth.openai.codexPatAuth': 'Codex PAT 授权',
  'admin.accounts.oauth.openai.codexPatDesc': '导入 Codex Personal Access Token，用于 Codex 相关请求。',
  'admin.accounts.oauth.openai.codexPatHint': '每行一个 PAT，批量导入时会逐个创建账号。',
  'admin.accounts.oauth.openai.codexPatImportAndCreate': '导入 PAT 并创建账号',
  'admin.accounts.oauth.openai.codexPatInputLabel': 'Codex PAT',
  'admin.accounts.oauth.openai.codexPatPlaceholder': '粘贴 Codex PAT，每行一个',
  'admin.accounts.oauth.openai.mobileRefreshTokenAuth': '移动端 Refresh Token 授权',
  'admin.accounts.openai.codexCLIOnlyAppServer': '仅允许 Codex CLI / App Server 客户端',
  'admin.accounts.openai.codexCLIOnlyAppServerDesc': '启用后仅接受符合 Codex CLI 或 App Server 指纹的请求。',
  'admin.accounts.openai.wsModeHttpBridge': 'HTTP 桥接模式',
  'admin.accounts.openaiQuotaReset.collapseExpirations': '收起重置额度到期时间',
  'admin.accounts.openaiQuotaReset.confirmMessage': '确认消耗 1 次重置额度？当前可用 {count} 次。',
  'admin.accounts.openaiQuotaReset.confirmTitle': '确认重置 OpenAI 额度',
  'admin.accounts.openaiQuotaReset.count': '次数',
  'admin.accounts.openaiQuotaReset.countTooltipLoad': '查询可用重置次数',
  'admin.accounts.openaiQuotaReset.countTooltipRefresh': '刷新可用重置次数',
  'admin.accounts.openaiQuotaReset.expandExpirations': '展开 {count} 个到期时间',
  'admin.accounts.openaiQuotaReset.expirationDetails': '重置额度到期明细',
  'admin.accounts.openaiQuotaReset.expiresAt': '{time} 到期',
  'admin.accounts.openaiQuotaReset.expiresAtFull': '到期时间：{time}',
  'admin.accounts.openaiQuotaReset.noCreditsAvailable': '没有可用的重置额度',
  'admin.accounts.openaiQuotaReset.reset': '重置',
  'admin.accounts.openaiQuotaReset.resetSuccess': '已重置额度窗口：{windows}',
  'admin.accounts.openaiQuotaReset.resetTooltipNeedQuery': '请先查询可用重置次数',
  'admin.accounts.openaiQuotaReset.resetTooltipNoCredits': '没有可用重置次数',
  'admin.accounts.openaiQuotaReset.resetTooltipReady': '消耗 1 次重置额度',
  'admin.accounts.openaiQuotaReset.resetTooltipShadow': '影子账号不支持直接重置，请在母账号操作',
  'admin.accounts.toModel': '目标模型',
  'admin.accounts.usageWindow.grokLastHeadersSeen': '最近响应头',
  'admin.accounts.usageWindow.grokLastProbe': '最近探测',
  'admin.accounts.usageWindow.grokLastStatus': '最近状态',
  'admin.accounts.usageWindow.grokNoHeaders': '未检测到 Grok 配额响应头',
  'admin.accounts.usageWindow.grokProbe': '探测 Grok 配额',
  'admin.accounts.usageWindow.grokProbeTooltip': '发送一次轻量探测请求以刷新 Grok 配额响应头',
  'admin.accounts.usageWindow.grokRequests': 'Grok 请求',
  'admin.accounts.usageWindow.grokResetUnsupported': '不支持重置',
  'admin.accounts.usageWindow.grokResetUnsupportedTooltip': 'Grok 当前不支持通过控制台重置额度窗口',
  'admin.accounts.usageWindow.grokRetryAfter': 'Retry-After',
  'admin.accounts.usageWindow.grokTokens': 'Grok Tokens',
  'admin.accounts.usageWindow.grokUnknown': 'Grok 配额未知',
  'admin.channelMonitor.form.jitterSeconds': '抖动秒数',
  'admin.channelMonitor.form.jitterSecondsHint': '为监控调度增加随机抖动，避免同一时间集中请求。',
  'admin.channels.emptyModelsInPricing': '请至少配置一个模型价格。',
  'admin.channels.form.cacheReadPriceShort': '缓存读',
  'admin.channels.form.cacheWritePriceShort': '缓存写',
  'admin.channels.form.inclusive': '包含',
  'admin.channels.form.maxTokens': '最大 Tokens',
  'admin.channels.form.minTokens': '最小 Tokens',
  'admin.channels.noGroupsSelected': '请至少选择一个分组。',
  'admin.groups.failedToSave': '保存失败',
  'admin.groups.rateLabel': '倍率',
  'admin.ops.customTimeRange.endTime': '结束时间',
  'admin.ops.customTimeRange.startTime': '开始时间',
  'admin.ops.errorLog.ip': 'IP',
  'admin.ops.result': '结果',
  'admin.ops.runtime.metricThresholds': '指标阈值',
  'admin.ops.runtime.metricThresholdsHint': '配置运行时健康评分和告警显示使用的阈值。',
  'admin.ops.runtime.requestErrorRateMaxPercent': '请求错误率上限（%）',
  'admin.ops.runtime.requestErrorRateMaxPercentHint': '超过该比例时请求错误率指标会标记为异常。',
  'admin.ops.runtime.slaMinPercent': 'SLA 最低百分比',
  'admin.ops.runtime.slaMinPercentHint': '低于该值时 SLA 指标会标记为异常。',
  'admin.ops.runtime.ttftP99MaxMs': 'TTFT P99 上限（毫秒）',
  'admin.ops.runtime.ttftP99MaxMsHint': '超过该值时首 token 延迟指标会标记为异常。',
  'admin.ops.runtime.upstreamErrorRateMaxPercent': '上游错误率上限（%）',
  'admin.ops.runtime.upstreamErrorRateMaxPercentHint': '超过该比例时上游错误率指标会标记为异常。',
  'admin.ops.systemLogs.all': '全部',
  'admin.ops.systemLogs.caller': '记录调用方',
  'admin.ops.systemLogs.cleanCurrentFilters': '清理当前筛选',
  'admin.ops.systemLogs.cleanupConfirm': '确认清理当前筛选条件匹配的系统日志？',
  'admin.ops.systemLogs.cleanupFailed': '清理系统日志失败',
  'admin.ops.systemLogs.cleanupSuccess': '系统日志已清理',
  'admin.ops.systemLogs.component': '组件',
  'admin.ops.systemLogs.componentPlaceholder': '例如 gateway',
  'admin.ops.systemLogs.description': '查看系统运行日志、写入健康状态和运行时日志配置。',
  'admin.ops.systemLogs.dropped': '丢弃',
  'admin.ops.systemLogs.empty': '暂无系统日志',
  'admin.ops.systemLogs.endTime': '结束时间',
  'admin.ops.systemLogs.failed': '失败',
  'admin.ops.systemLogs.keyId': 'Key ID',
  'admin.ops.systemLogs.keyword': '关键词',
  'admin.ops.systemLogs.keywordPlaceholder': '搜索消息、错误或请求 ID',
  'admin.ops.systemLogs.latestWriteError': '最近写入错误：',
  'admin.ops.systemLogs.level': '级别',
  'admin.ops.systemLogs.loadFailed': '加载系统日志失败',
  'admin.ops.systemLogs.logDetails': '日志详情',
  'admin.ops.systemLogs.model': '模型',
  'admin.ops.systemLogs.platform': '平台',
  'admin.ops.systemLogs.queue': '队列',
  'admin.ops.systemLogs.refreshHealth': '刷新健康状态',
  'admin.ops.systemLogs.resetDefaults': '恢复默认',
  'admin.ops.systemLogs.resetRuntimeConfigConfirm': '确认恢复系统日志运行配置为默认值？',
  'admin.ops.systemLogs.retentionDays': '保留天数',
  'admin.ops.systemLogs.runtimeConfig': '运行时配置',
  'admin.ops.systemLogs.runtimeConfigActive': '系统日志运行配置已生效',
  'admin.ops.systemLogs.runtimeConfigReset': '系统日志运行配置已恢复默认',
  'admin.ops.systemLogs.runtimeConfigResetFailed': '恢复系统日志运行配置失败',
  'admin.ops.systemLogs.runtimeConfigSaveFailed': '保存系统日志运行配置失败',
  'admin.ops.systemLogs.sampling': '启用采样',
  'admin.ops.systemLogs.samplingInitial': '初始保留条数',
  'admin.ops.systemLogs.samplingThereafter': '后续采样间隔',
  'admin.ops.systemLogs.saveAndApply': '保存并应用',
  'admin.ops.systemLogs.search': '搜索日志',
  'admin.ops.systemLogs.stacktraceThreshold': '堆栈阈值',
  'admin.ops.systemLogs.startTime': '开始时间',
  'admin.ops.systemLogs.time': '时间',
  'admin.ops.systemLogs.timeRange': '时间范围',
  'admin.ops.systemLogs.title': '系统日志',
  'admin.ops.systemLogs.written': '写入',
  'admin.ops.timeRange.custom': '自定义',
  'admin.riskControl.action.cyberPolicy': 'Cyber 策略',
  'admin.riskControl.cyberPolicyExcludeBan': '排除封禁',
  'admin.riskControl.cyberPolicyExcludeBanHint': '启用后，Cyber 策略命中不会触发封禁动作。',
  'admin.riskControl.defaultBlockMessage': '请求因风险控制策略被拦截。',
  'admin.riskControl.matchedKeyword': '命中关键词',
  'admin.riskControl.violationNotCounted': '未计入违规次数',
  'admin.settings.features.riskControl.cyberSessionBlock': 'Cyber 会话封禁',
  'admin.settings.features.riskControl.cyberSessionBlockHint': '按会话维度阻断连续命中的 Cyber 风险请求。',
  'admin.settings.features.riskControl.cyberSessionBlockTTL': 'Cyber 会话封禁时长',
  'admin.settings.gatewayForwarding.addSystemBlock': '添加系统提示块',
  'admin.settings.gatewayForwarding.cacheTTL1h': '1 小时',
  'admin.settings.gatewayForwarding.cacheTTL5m': '5 分钟',
  'admin.settings.gatewayForwarding.claudeOAuthSystemPromptBlocks': 'Claude OAuth 系统提示块',
  'admin.settings.gatewayForwarding.claudeOAuthSystemPromptBlocksHint': '按顺序向 Claude OAuth 请求注入系统提示，可控制每段是否缓存。',
  'admin.settings.gatewayForwarding.claudeOAuthSystemPromptInjection': 'Claude OAuth 系统提示注入',
  'admin.settings.gatewayForwarding.claudeOAuthSystemPromptInjectionHint': '启用后为 Claude OAuth 请求自动注入额外系统提示。',
  'admin.settings.gatewayForwarding.clientDatelineNormalization': '客户端日期线标准化',
  'admin.settings.gatewayForwarding.clientDatelineNormalizationHint': '规范化客户端日期线信息，降低上游因时区/日期差异导致的异常。',
  'admin.settings.gatewayForwarding.codexAddRow': '添加规则',
  'admin.settings.gatewayForwarding.codexAllowAppServer': '允许 App Server 客户端',
  'admin.settings.gatewayForwarding.codexAllowAppServerDesc': '在 Codex CLI 限制模式下，额外允许 App Server 指纹的客户端。',
  'admin.settings.gatewayForwarding.codexBlacklist': 'Codex 黑名单',
  'admin.settings.gatewayForwarding.codexBlacklistDesc': '匹配 Originator 或 User-Agent 的请求将被拒绝。',
  'admin.settings.gatewayForwarding.codexClientRestrictionTitle': '客户端限制',
  'admin.settings.gatewayForwarding.codexFingerprintNoRequiredWarn': '至少建议保留一个必需指纹信号。',
  'admin.settings.gatewayForwarding.codexFingerprintSignals': 'Codex 指纹信号',
  'admin.settings.gatewayForwarding.codexFingerprintSignalsDesc': '配置用于识别 Codex 客户端的请求头或响应体路径。',
  'admin.settings.gatewayForwarding.codexFpMatchPlaceholder': '匹配值或路径',
  'admin.settings.gatewayForwarding.codexFpRequired': '必需',
  'admin.settings.gatewayForwarding.codexFpTypeBodyPath': 'Body 路径',
  'admin.settings.gatewayForwarding.codexFpTypeHeaderExact': 'Header 精确',
  'admin.settings.gatewayForwarding.codexFpTypeHeaderPrefix': 'Header 前缀',
  'admin.settings.gatewayForwarding.codexHardeningDesc': '限制 Codex 客户端版本、指纹和来源，降低异常客户端风险。',
  'admin.settings.gatewayForwarding.codexHardeningTitle': 'Codex 安全加固',
  'admin.settings.gatewayForwarding.codexOriginatorPlaceholder': 'Originator',
  'admin.settings.gatewayForwarding.codexRemoveRow': '删除',
  'admin.settings.gatewayForwarding.codexUaContainsPlaceholder': 'User-Agent 包含',
  'admin.settings.gatewayForwarding.codexVersionHint': '留空表示不限制对应版本边界。',
  'admin.settings.gatewayForwarding.codexWhitelist': 'Codex 白名单',
  'admin.settings.gatewayForwarding.codexWhitelistDesc': '匹配白名单的请求可被显式允许。',
  'admin.settings.gatewayForwarding.codexWhitelistSkipFingerprint': '跳过指纹',
  'admin.settings.gatewayForwarding.codexWhitelistSkipFingerprintTooltip': '命中该白名单规则时不再校验 Codex 指纹。',
  'admin.settings.gatewayForwarding.maxCodexVersion': '最高 Codex 版本',
  'admin.settings.gatewayForwarding.maxCodexVersionPlaceholder': '例如 0.35.0',
  'admin.settings.gatewayForwarding.minCodexVersion': '最低 Codex 版本',
  'admin.settings.gatewayForwarding.minCodexVersionPlaceholder': '例如 0.20.0',
  'admin.settings.gatewayForwarding.resetSystemBlocks': '重置系统提示块',
  'admin.settings.gatewayForwarding.systemBlockCacheControl': '启用缓存控制',
  'admin.settings.gatewayForwarding.systemBlockHide': '收起',
  'admin.settings.gatewayForwarding.systemBlockPreset': '预设',
  'admin.settings.gatewayForwarding.systemBlockPresetBilling': '计费说明',
  'admin.settings.gatewayForwarding.systemBlockPresetCustom': '自定义',
  'admin.settings.gatewayForwarding.systemBlockPresetExpansion': '能力扩展',
  'admin.settings.gatewayForwarding.systemBlockPresetIdentity': '身份说明',
  'admin.settings.gatewayForwarding.systemBlockShow': '展开',
  'admin.settings.gatewayForwarding.systemBlockText': '提示内容',
  'admin.settings.gatewayForwarding.systemBlockTitle': '系统提示块 #{index}',
  'admin.settings.gatewayForwarding.systemBlockType': '类型',
  'admin.settings.gatewayForwarding.systemBlockTypeText': '文本',
  'admin.settings.openaiExperimentalScheduler.defaultPlaceholder': '默认：{value}',
  'admin.settings.openaiExperimentalScheduler.errorRateWeight': '错误率权重',
  'admin.settings.openaiExperimentalScheduler.loadWeight': '负载权重',
  'admin.settings.openaiExperimentalScheduler.previousResponseWeight': '上一响应权重',
  'admin.settings.openaiExperimentalScheduler.priorityWeight': '优先级权重',
  'admin.settings.openaiExperimentalScheduler.queueWeight': '队列权重',
  'admin.settings.openaiExperimentalScheduler.quotaHeadroomWeight': '额度余量权重',
  'admin.settings.openaiExperimentalScheduler.resetWeight': '重置权重',
  'admin.settings.openaiExperimentalScheduler.sessionStickyWeight': '会话粘性权重',
  'admin.settings.openaiExperimentalScheduler.stickyWeightedDescription': '综合账号负载、错误率、延迟和会话粘性选择上游账号。',
  'admin.settings.openaiExperimentalScheduler.stickyWeightedTitle': '启用粘性加权调度',
  'admin.settings.openaiExperimentalScheduler.subscriptionPriorityDescription': '订阅优先级会参与账号调度评分。',
  'admin.settings.openaiExperimentalScheduler.subscriptionPriorityTitle': '订阅优先级',
  'admin.settings.openaiExperimentalScheduler.topKLabel': '候选 Top K',
  'admin.settings.openaiExperimentalScheduler.ttftWeight': 'TTFT 权重',
  'admin.settings.openaiExperimentalScheduler.weightsDescription': '调整各因子在调度评分中的权重。',
  'admin.settings.openaiExperimentalScheduler.weightsTitle': '调度权重',
  'admin.settings.payment.addCustomMethod': '添加自定义方式',
  'admin.settings.payment.customMethodDisplayName': '显示名称',
  'admin.settings.payment.customMethodType': '方式标识',
  'admin.settings.payment.customMethodUpstreamType': '上游方式',
  'admin.settings.payment.easypayCustomMethods': 'EasyPay 自定义支付方式',
  'admin.settings.payment.easypayCustomMethodsHint': '用于映射 EasyPay 返回的自定义支付类型。',
  'admin.settings.payment.subscriptionUsdToCnyRate': '订阅美元兑人民币汇率',
  'admin.settings.payment.subscriptionUsdToCnyRateDisabled': '未启用人民币订阅支付时不使用该汇率。',
  'admin.settings.payment.subscriptionUsdToCnyRateHint': '用于订阅套餐的美元价格换算为人民币支付金额。',
  'admin.settings.payment.validationEasyPayCustomMethodDuplicate': '自定义支付方式不能重复。',
  'admin.settings.payment.validationEasyPayCustomMethodPrefixReserved': '自定义支付方式不能使用保留前缀。',
  'admin.settings.payment.validationEasyPayCustomMethodRequired': '请填写自定义支付方式。',
  'admin.settings.payment.validationEasyPayCustomMethodReserved': '该支付方式为系统保留值。',
  'admin.settings.payment.validationEasyPayCustomMethodTypeInvalid': '支付方式标识格式不正确。',
  'admin.settings.payment.validationEasyPayCustomMethodUpstreamTypeInvalid': '上游支付方式格式不正确。',
  'admin.subscriptions.failedToRestore': '恢复订阅失败',
  'admin.subscriptions.restore': '恢复',
  'admin.subscriptions.restoreConfirm': '确认恢复该订阅？',
  'admin.subscriptions.restoreSubscription': '恢复订阅',
  'admin.subscriptions.subscriptionRestored': '订阅已恢复',
  'admin.users.allApiKeyGroups': '全部 API Key 分组',
  'admin.users.allAuthorizedGroups': '全部授权分组',
  'admin.users.apiKeyGroupDisabled': '已禁用',
  'admin.users.apiKeyGroupExclusive': '独享',
  'admin.users.apiKeyGroupFilter': 'API Key 分组筛选',
  'admin.users.apiKeyGroupPublic': '公开',
  'admin.users.apiKeyGroupSubscription': '订阅',
  'admin.users.authorizedGroupFilter': '授权分组筛选',
  'admin.users.passwordCopied': '密码已复制',
  'admin.users.searchApiKeyGroups': '搜索 API Key 分组',
  'admin.users.searchAuthorizedGroups': '搜索授权分组',
  'auth.dingtalkProviderName': '钉钉',
  'common.apply': '应用',
  'common.clear': '清空',
  'common.creating': '创建中...',
  'common.login': '登录',
  'common.peakRateImageNote': '；图像价格按图像计费规则另行计算',
  'common.peakRateTooltip': '峰值倍率窗口：{window}',
  'common.required': '必填',
  'common.sending': '发送中...',
  'common.tryAgain': '重试',
  'customPage.copiedCode': '代码已复制',
  'customPage.copyCode': '复制代码',
  'customPage.copyCodeFailed': '复制代码失败',
  'customPage.tableOfContents': '目录',
  'keys.columnSettings': '列设置',
  'keys.currentConcurrency': '当前并发',
  'payment.admin.queryRefundStatus': '查询退款状态',
  'payment.admin.refundPending': '退款处理中',
  'payment.admin.subscriptionCnyPayPreview': '人民币支付预览：¥{amount}',
  'payment.admin.subscriptionCnyPayPreviewWithFee': '含手续费预览：¥{amount}',
  'payment.planCard.peakRate': '峰值倍率 {rate}x',
  'payment.status.refund_pending': '退款处理中',
  'usage.cacheBreakdown': '缓存明细',
  'usage.cacheCreationTokensLabel': '缓存创建 Tokens',
  'usage.cacheReadTokensLabel': '缓存读取 Tokens',
  'usage.cacheTotal': '缓存合计',
  'usage.cyber': 'Cyber',
  'usage.errors.allStatuses': '全部状态',
  'usage.ipGeo.batchFailed': '批量获取地区失败',
  'usage.ipGeo.batchFetch': '批量获取地区',
  'usage.ipGeo.batchFetching': '批量获取中...',
  'usage.ipGeo.detailAccuracy': '精度',
  'usage.ipGeo.detailCoordinates': '坐标',
  'usage.ipGeo.detailOrg': '组织',
  'usage.ipGeo.detailTimezone': '时区',
  'usage.ipGeo.failed': '获取失败',
  'usage.ipGeo.fetch': '获取地区',
  'usage.ipGeo.fetching': '获取中...',
  'usage.ipGeo.pending': '{count} 个 IP 待获取地区',
  'usage.ipGeo.private': '内网地址',
  'usage.ipGeo.refreshTitle': '刷新 IP 地区',
}
