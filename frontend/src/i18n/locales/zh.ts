  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_allowedMethodsNote: '允许方式说明',
        field_reconcileWindowHours: '对账窗口（小时）',
        field_autoFulfillFeePayments: '手续费方式自动入账',
        ...
        field_wiseQuickPayBaseUrlHint: 'Wise Quick Pay / payment link 基础链接，系统会自动追加 amount、currency、description',
        field_wiseApiBaseHint: 'Wise API 地址，生产环境通常为 https://api.wise.com',
        field_wiseWebhookPublicKeyHint: 'Wise Webhook RSA 公钥，用于校验 X-Signature-SHA256',
        field_wiseSettlementStrategyHint: 'v1 固定 exact_only，仅到账金额等于订单金额时自动入账',
        field_wiseAutoFulfillFeePaymentsHint: 'v1 必须为 false；card / Apple Pay / Google Pay 手续费场景进入人工审核',
        field_cid: '支付渠道 ID',
        ...
        wiseWebhookHint: '在 Wise 后台配置 Webhook，并订阅 balance/account-details 入账相关事件。',
