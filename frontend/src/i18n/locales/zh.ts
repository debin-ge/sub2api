export default {
  ...
  benchmark: {
    ...
    public: {
      home: {
        eyebrow: '公开 Benchmark',
        title: 'AI Model Radar',
        description: '按公开 Benchmark 展示模型能力分，并单独列出延迟、成功率、Token 和成本等运行指标。',
        loadingTitle: '正在加载 Radar 数据',
        loadingDescription: '请稍候，正在读取最新公开排行。',
        errorTitle: '暂时无法加载 Radar 数据',
        loadError: '公开 Radar 数据读取失败。',
      },
      empty: {
        title: '暂无 Radar 数据',
      ...
      summary: {
        targetsLabel: '参评模型',
        targetsCaption: '公开可见目标',
        averageScoreLabel: '平均能力分',
        averageScoreCaption: '仅表示任务能力表现',
        sampleStatusLabel: '样本状态',
        sampleStatusCaption: '达到有效样本的模型',
        passedLabel: '通过题数',
        passedCaption: '所有模型累计通过/总题数',
        latestRunLabel: '最新运行',
        latestRunEmptyCaption: '暂无完成记录',
      },
      dimension: {
        title: '能力维度',
        description: '按公开结果汇总各维度能力分。',
        empty: '暂无维度数据',
      },
      trend: {
        title: '趋势',
        description: '最近运行的能力分变化趋势。',
      },
      table: {
        rank: '排名',
        model: '模型',
    ...
    admin: {
      ...
      targets: {
        title: '评测目标',
        description: '管理参与 benchmark 的模型和通道快照。',
        refresh: '刷新',
        create: '创建目标',
        edit: '编辑',
        update: '更新目标',
        loadError: '加载评测目标失败',
        createError: '创建评测目标失败',
        createSuccess: '评测目标已创建',
        updateError: '更新评测目标失败',
        updateSuccess: '评测目标已更新',
        deleteError: '删除评测目标失败',
        deleteSuccess: '评测目标已删除',
        deleteConfirm: '确定要删除该评测目标吗？此操作不可撤销。',
        jsonError: 'Metadata 必须是有效的 JSON 对象。',
        selectChannel: '选择可运行渠道',
        channelLoading: '正在加载渠道',
        channelLoadError: '加载渠道失败',
        channelHint: '雷达测试会通过所选渠道执行模型请求。',
        channelReady: '该渠道已关联 OpenAI 分组，可用于雷达测试。',
        channelRequired: '请选择一个已关联 OpenAI 分组的渠道。',
        noRunnableChannels: '暂无可运行渠道',
        noRunnableChannelsHint: '请先在渠道管理中创建启用状态、且关联 OpenAI 分组的渠道。',
        channelNoGroups: '未关联分组',
        channelNoOpenAIGroup: '未关联 OpenAI 分组',
        groupLoadError: '加载分组失败',
        modelLoadError: '加载模型失败',
        selectGroup: '选择分组',
        groupLoading: '正在加载分组',
        noGroups: '暂无可选分组',
        groupHint: '先选择订阅或分组，再选择具体分组。',
        groupReady: '该分组可用于标准雷达测试。',
        groupRequired: '请选择 OpenAI 分组和模型。',
        groupUnsupportedPlatform: '该分组平台为 {platform}，当前标准雷达执行暂只支持 OpenAI 分组。',
        selectModel: '选择模型',
        modelLoading: '正在加载模型',
        ...
        emptyTitle: '暂无目标',
        emptyDescription: '添加模型目标后会显示在这里。',
        fields: {
          sourceType: '来源方式',
          group: '分组',
          modelName: '模型名称',
          ...
          channelSnapshot: '渠道名称快照',
          channelSnapshotHint: '选择渠道后自动生成',
          supportedTaskTypes: '支持任务类型',
          maxConcurrency: '最大并发',
          perRunBudget: '单次预算',
          dailyBudget: '每日预算',
          enabled: '启用',
      ...
      tasks: {
        ...
        customType: '自定义',
        loadError: '加载评测任务失败',
        createError: '创建评测任务失败',
        updateError: '更新评测任务失败',
        deleteError: '删除评测任务失败',
        createSuccess: '评测任务已创建',
        updateSuccess: '评测任务已更新',
        deleteSuccess: '评测任务已删除',
      ...
      profiles: {
        title: '评测配置',
        description: '管理评测目标、任务类型与采样规模。',
        refresh: '刷新',
        createTitle: '创建 Profile',
        createDescription: '选择 target、task type 与运行规模。',
        previewTitle: 'Profile 预览',
        previewDescription: '基于现有 profile 调整筛选条件后预览样本量。',
        createError: '创建评测配置失败',
        createSuccess: '评测配置已创建',
        update: '更新 Profile',
        updateError: '更新评测配置失败',
        updateSuccess: '评测配置已更新',
        edit: '编辑',
        editTitle: '编辑 Profile',
        deleteConfirm: '确认删除该 profile？',
        deleteError: '删除评测配置失败',
        deleteSuccess: '评测配置已删除',
        loadError: '加载评测配置失败',
        previewError: '预览评测配置失败',
        jsonError: '{field} 必须是合法 JSON 对象',
        noTargets: '暂无 target。',
        chooseProfile: '请选择 profile',
        preview: '预览',
        fields: {
          name: '名称',
          suiteId: 'Suite ID',
          ...
          taskScale: '任务规模',
          profile: 'Profile',
          taskCountLimit: '任务数量上限',
          perTypeLimit: '按类型上限 JSON',
          difficultyFilter: '难度筛选',
          tagFilter: '标签筛选',
          samplingStrategy: '采样策略',
          selectionSeed: '选择种子',
          runtimeConfig: '运行配置 JSON',
          scoringConfig: '评分配置 JSON',
          enabled: '启用',
          metadata: 'Metadata JSON',
        },
        previewCards: {
          ...
          estimatedCost: '预估成本',
          rankingBasis: '排名依据',
          selectedTasks: '选中任务 ID 数',
          selectedTargets: '选中目标 ID 数',
        },
        rankingBasis: {
          abilityScoreOnly: '仅能力分',
        },
        validation: {
          suiteId: 'Suite ID 必须大于 0',
        },
        columns: {
          name: '名称',
          targets: '目标数',
        ...
        emptyTitle: '暂无 Profile',
        emptyDescription: '创建第一个 benchmark profile 后会显示在这里。',
      },
      runs: {
        title: '评测运行',
        ...
        cancelError: '取消评测运行失败',
        processError: '处理评测运行失败',
        processDueError: '处理到期任务失败',
        createSuccess: 'Run #{id} 已创建',
        cancelSuccess: 'Run 已取消',
        processSuccess: '已处理 {count} 个任务',
        processDueSuccess: '已处理 {count} 个到期任务',
        noTargets: '暂无 target。',
        emptyTitle: '暂无 Run',
      ...
      schedules: {
        ...
        triggerSuccess: '计划已触发，Run #{id} 已创建',
        triggerError: '触发计划失败',
        noTargets: '暂无 target。',
        emptyTitle: '暂无计划',
        emptyDescription: '创建第一个 benchmark 计划。',
        fields: {
          name: '名称',
          cronExpr: 'Cron 表达式',
          taskCount: '任务数',
      ...
      runDetail: {
        title: 'Run 详情',
        defaultDescription: '查看单次运行结果与快照。',
        ...
        process: '处理',
        cancel: '取消',
        publish: '发布 public snapshot',
        publishSuccess: '公开快照已发布',
        publishError: '发布 public snapshot 失败',
        processSuccess: '已处理 {count} 个处理步骤',
        processError: '处理 Run 失败',
        cancelSuccess: 'Run 已取消',
        cancelError: '取消 Run 失败',
        loadError: '加载 Run 详情失败',
        emptySelectTitle: '请选择 Run',
        emptySelectDescription: '路由接入后可直接通过 run id 打开详情页。',
        rankingTitle: '排行榜',
        ...
        noResults: '暂无 result。',
        noInvalidReasons: '暂无 invalid reason。',
        noInvalidReasonsShort: '无',
        targetResultsTitle: '单 target 结果明细',
        targetResultsCount: '{count} 条结果',
        noTargetResults: '暂无 target result。',
        insufficientSample: '样本不足',
        overview: {
          status: '状态',
          plannedTargets: '计划目标数',
          plannedTasks: '计划任务数',
          plannedResults: '计划结果数',
        },
        confidenceLevels: {
          high: '高',
          medium: '中',
  ...
  nav: {
    ...
    channelMonitor: '渠道监控',
    modelRadar: '模型能力雷达',
    benchmarkDashboard: '雷达概览',
    benchmarkTargets: '评测目标',
    benchmarkTasks: '评测任务',
    benchmarkProfiles: '评测配置',
    benchmarkSchedules: '运行计划',
    benchmarkRuns: '评测运行',
    channelStatus: '渠道状态',
    riskControl: '风控中心',
  },
  ...
  admin: {
    ...
    settings: {
      ...
      features: {
        ...
        benchmark: {
          title: '模型能力雷达',
          description: '管理 benchmark/radar 子系统的运行、公开展示与首页接入参数。',
          configureLink: '前往 模型能力雷达 > 雷达概览',
          enabled: '启用 Benchmark',
          enabledHint: '关闭后禁止创建新的 benchmark run，但保留历史结果与管理入口。',
          publicEnabled: '启用公开榜单',
          publicEnabledHint: '关闭后 public radar 返回稳定空结构，首页不展示公开快照内容。',
          homeEnabled: '启用首页雷达',
          homeEnabledHint: '仅在未配置 home_content 时生效，用公开 radar 作为默认首页内容。',
          scheduleEnabled: '启用定时调度',
          scheduleEnabledHint: '关闭后 benchmark schedule 不会自动触发。',
          defaultSuite: '默认 Suite ID',
          defaultSuiteHint: '创建 benchmark 配置时预填的 suite 标识。0 表示未指定默认 suite。',
          globalConcurrency: '全局并发',
          globalConcurrencyHint: 'profile/run 未显式覆盖时使用的默认并发数。',
          defaultTimeoutSeconds: '默认超时（秒）',
          defaultTimeoutSecondsHint: 'profile/run 未显式覆盖时使用的单任务默认超时。',
          lowConfidenceThreshold: '低置信阈值',
          lowConfidenceThresholdHint: 'coverage 低于该阈值时标记为 low / 样本不足。',
          highConfidenceThreshold: '高置信阈值',
          highConfidenceThresholdHint: 'coverage 达到该阈值后标记为 high。',
        },
        availableChannels: {
          title: '可用渠道',
