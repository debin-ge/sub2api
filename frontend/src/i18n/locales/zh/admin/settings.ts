    ...
    settings: {
      ...
      features: {
        ...
        modelPlaza: {
          ...
          enabled: '启用模型广场',
          enabledHint: '开启后顶栏显示入口，页面可通过 /plaza 独立访问。',
        ...
        affiliate: {
          ...
          registrationReward: '注册邀请奖励金额',
          registrationRewardHint: '新用户使用邀请返利码注册成功后发给邀请人的固定金额。0 = 关闭注册奖励。',
          registrationRewardInvalid: '注册邀请奖励金额必须是 0 到 999999999999.9998 之间的有效数字。',
      ...
      registration: {
        ...
        emailSuffixBlacklistHint:
          "禁止使用指定域名的邮箱注册账号（例如 {'@'}nimail.cn, *.edu.cn）",
        emailSuffixBlacklistPlaceholder: "{'@'}nimail.cn, *.edu.cn",
        emailSuffixBlacklistInputHint: '留空则不限制。使用 *.edu.cn 可禁止 edu.cn 及其所有子域名。',
        ...
        invitationCodeHint: '开启后，在注册页面显示邀请码输入框',
        invitationCodeRequired: '注册时必须填写邀请码',
        invitationCodeRequiredHint: '开启后必须填写有效邀请码；关闭后邀请码为选填',
        passwordReset: '忘记密码',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 {siteName} 用户登录',
      ...
      site: {
        ...
        siteSubtitlePlaceholder: 'AI API 网关',
        apiBaseUrl: 'API 端点地址',
        ...
        contactQrCode: '企业微信客服二维码',
        uploadQrCode: '上传二维码',
        contactQrCodeHint: '上传企业微信客服二维码。配置后，用户点击“联系客服”即可弹窗扫码添加。支持 PNG、JPG、WEBP，最大 500KB。',
        docUrl: '文档链接',
