export default {
    accounts: {
      ...
      providerIdentity: {
        title: 'Provider 身份与别名验证',
        description: '仅对全局独享根账号开放。principal 原文不会持久化，批准需要另一名当前管理员。',
        state: '验证状态',
        identityVersion: '身份版本',
        fingerprint: 'Principal 指纹',
        rawNotStored: '仅保存 Provider origin 与 principal 的 SHA-256；页面只显示前 16 位指纹。',
        proposeTitle: '发起验证申请',
        principalPlaceholder: 'Provider 控制台中的稳定 principal ID',
        evidencePlaceholder: '脱敏证据引用，例如 ticket:IDENTITY-1',
        reasonPlaceholder: '说明如何核验 Provider 身份',
        propose: '提交双人验证',
        proposed: '验证申请已提交',
        pendingTitle: '待审批申请',
        proposedBy: '申请管理员 #{id}',
        decisionPlaceholder: '独立复核结论',
        approve: '批准并绑定',
        reject: '拒绝',
        approved: 'Provider 身份已验证',
        rejected: '申请已拒绝',
        revokeTitle: '紧急撤销',
        revokeReasonPlaceholder: '说明泄露、错绑或撤销原因',
        revokeWarning: '撤销会同时停用所有已登记为同一 principal 的账号别名，且不可原地恢复。',
        revoke: '撤销全部别名',
        revoked: 'Provider principal 已撤销',
        history: '历史申请',
        loadFailed: '加载 Provider 身份状态失败',
        operationFailed: 'Provider 身份操作失败',
        states: { unverified: '未验证', verified: '已验证', revoked: '已撤销' },
        kinds: { account: '账号', organization: '组织', project: '项目', tenant: '租户', workspace: '工作区' }
      },
      createAccount: '添加账号',
      autoRefresh: '自动刷新',
      ...
      openai: {
		...
		endpointCapabilitiesDesc:
		  '用于调度筛选。OpenAI 官方端点需要只读探测成功或显式覆盖；自定义 Base URL 必须显式勾选。',
		...
		videoCapabilityProbe: 'Videos 只读能力探测',
		videoCapabilityProbeAction: '执行探测',
		videoCapabilityProbeCompleted: 'Videos 能力探测已完成。',
		videoCapabilityProbeFailed: 'Videos 能力探测失败。',
		videoCapabilityProbeStatus: {
		  supported: '支持',
		  unsupported: '不支持',
		  unknown: '未知',
		},
        videoDisclosureTitle: '视频 Provider 信息披露',
        videoDisclosureDescription: '配置账号所有者以及该账号允许的最高披露级别；系统和分组策略仍可进一步收紧。',
        videoOwnerUserId: '独享用户 ID',
        videoOwnerUserIdPlaceholder: '可选用户 ID',
        videoOwnerUserIdHint: '创建全局用户独享账号，文本、图片和视频调度均受用户归属约束。创建后不可更改归属。',
        videoOwnerUserIdInvalid: '独享用户 ID 必须为正整数。',
        videoDisclosurePolicy: '账号披露上限',
        videoDisclosurePolicyHint: '无论如何配置，共享账号的长期凭证都不会返回。',
        videoDisclosureInherit: '继承系统和分组策略',
        videoDisclosureNone: '不披露',
        videoDisclosureIdentity: 'Provider 信息和上游任务 ID',
        videoDisclosureTaskAccess: '任务级临时访问凭证',
        videoDisclosureDedicatedCredentials: '独享账号凭证',
        videoDedicatedCredentialsWarning: '长期凭证要求上游隔离已验证、全局 owner 匹配且任务冻结的身份版本一致。填写 owner 或更换 API key 不代表完成隔离验证。',
        accountOwnershipImmutableHint: '账号归属不可原地更改。请使用新的隔离上游身份迁移，不可重标记历史共享账号。',
        accountIsolationUnverified: '上游隔离未验证：不会返回长期凭证。启用 Videos 能力不代表隔离验证通过。',
        accountIsolationVerified: '上游隔离已验证，身份版本 {version}。',
        accountIsolationRevoked: '隔离验证已撤销：禁止新付费调度和长期凭证披露。',
        videoDedicatedOwnerRequired: '启用独享账号凭证披露前，必须填写有效的独享用户 ID。',
