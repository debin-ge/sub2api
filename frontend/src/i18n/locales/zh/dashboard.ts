export default {
  ...
  keys: {
    ...
    notificationEmailRequired: '请先填写通知邮箱',
    rotateOnExpiryColumn: '到期轮换',
    changeNotification: 'API 密钥变动通知',
    rotateOnExpiry: '到期后自动轮换',
    sendVerificationCode: '发送验证码',
    sendingCode: '发送中',
    verificationCodeSent: '验证码已发送',
    verificationCodePlaceholder: '输入 6 位验证码',
    verificationCodeInvalid: '请输入有效的 6 位验证码',
    verifyEmail: '验证邮箱',
    verifyingEmail: '验证中',
    ...
    rotationRequiresExpiration: '到期自动轮换需要设置未来的过期时间',
    customKeyRotationWarning: '到期轮换后，自定义密钥将替换为系统随机密钥。',
    emailErrors: {
      API_KEY_NOTIFICATION_EMAIL_INVALID: '通知邮箱格式无效',
      API_KEY_EMAIL_VERIFICATION_INVALID: '验证码或验证凭证无效或已过期',
      API_KEY_EMAIL_VERIFICATION_LIMITED: '验证请求过于频繁，请稍后再试',
      API_KEY_NOTIFICATION_EMAIL_UNVERIFIED: '通知邮箱尚未验证',
      API_KEY_ROTATION_EXPIRY_REQUIRED: '到期自动轮换需要未来的过期时间',
      EMAIL_NOT_CONFIGURED: '平台尚未配置邮件服务'
    },
    status: {
      active: '活跃',
      inactive: '已停用',
  ...
  usage: {
    ...
    internalRelay: '内部中继',
    internalRelayHint: '此记录来自已验证的内部回环调用，不计入业务统计。',
    internalRelayParent: '内部中继；父请求：{requestId}',
    costDetails: '费用明细',
	...
	videoDuration: '视频时长',
	videoBillingUnit: '视频计费单位',
	videoUnits: '视频计费用量',
	videoUnitPrice: '视频单价',
	videoBaseCost: '视频基础费用',
	videoTokenUnit: '视频 Token',
	videoSecondUnit: '秒',
	videoRequestUnit: '次',
	secondsShort: '秒',
	perMillionVideoTokens: '/ 100 万视频 Token',
    imageCount: '图片张数',
  ...
  affiliate: {
    ...
    tips: {
      ...
      registrationReward: '新用户使用你的邀请码注册成功后，你可获得 {amount} 注册奖励。',
