export default {
  common: {
    ...
    processing: '处理中...',
    contactSupport: '联系客服',
    contactSupportScanHint: '请使用微信扫描二维码添加企业微信客服',
    viewSupportQrCode: '点击查看客服二维码',
    supportQrCodeAlt: '企业微信客服二维码',
    add: '添加',
  ...
  auth: {
    ...
    loginSucceededNavigationFailed: '登录已经成功，但页面加载失败。请刷新页面后重试。',
    actionSucceededNavigationFailed: '操作已经成功，但页面加载失败。请刷新页面后重试。',
    frontendUpdateRequired: '系统刚刚完成更新，请关闭当前页面后重新打开。',
    ...
    captchaClickTitle: '请按顺序点击下方目标',
    captchaSlideTitle: '请拖动滑块完成拼图',
    captchaDragTitle: '请将拼图拖动到正确位置',
    captchaRotateTitle: '请旋转图片到正确角度',
    captchaConfirm: '确认',
    captchaIncorrect: '验证未通过，已为您更换新的挑战。',
    captchaTooManyFailures: '失败次数过多，请稍后再试。',
    captchaUnavailable: '验证服务暂时不可用，请重试。',
    captchaRetry: '重试',
    ...
    affiliateCodePlaceholder: '输入邀请返利码（选填）',
    affiliateCodeValid: '邀请返利码有效',
    affiliateCodeInvalid: '邀请返利码无效',
    affiliateCodeDisabled: '邀请返利功能当前未开启',
    affiliateCodeServiceUnavailable: '邀请返利码暂时无法验证，请稍后重试',
    affiliateCodeValidating: '正在验证邀请返利码，请稍候',
    affiliateCodeInvalidCannotRegister: '邀请返利码无效，请检查后重试或清空',
    invitationSatisfiedByAffiliate: '已应用邀请返利码，可免填邀请码',
