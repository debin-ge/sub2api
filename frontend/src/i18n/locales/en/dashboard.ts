export default {
  ...
  keys: {
    ...
    notificationEmailPlaceholder: "receiver{'@'}example.com",
    notificationEmailRequired: 'Enter a notification email first',
    rotateOnExpiryColumn: 'Expiry Rotation',
    changeNotification: 'API Key Change Notifications',
    rotateOnExpiry: 'Rotate Automatically After Expiry',
    sendVerificationCode: 'Send Code',
    sendingCode: 'Sending',
    verificationCodeSent: 'Verification code sent',
    verificationCodePlaceholder: 'Enter the 6-digit code',
    verificationCodeInvalid: 'Enter a valid 6-digit verification code',
    ...
    rotationRequiresExpiration: 'Automatic rotation requires a future expiration time',
    customKeyRotationWarning: 'After expiry, the custom key will be replaced with a system-generated key.',
    emailErrors: {
      API_KEY_NOTIFICATION_EMAIL_INVALID: 'The notification email is invalid',
      API_KEY_EMAIL_VERIFICATION_INVALID: 'The code or verification token is invalid or expired',
      API_KEY_EMAIL_VERIFICATION_LIMITED: 'Too many verification requests; try again later',
      API_KEY_NOTIFICATION_EMAIL_UNVERIFIED: 'The notification email has not been verified',
      API_KEY_ROTATION_EXPIRY_REQUIRED: 'Automatic rotation requires a future expiration time',
  ...
  usage: {
	...
	videoBillingUnit: 'Video billing unit',
	videoUnits: 'Video billable units',
	videoUnitPrice: 'Video unit price',
	videoBaseCost: 'Video base cost',
	videoTokenUnit: 'video tokens',
	videoSecondUnit: 'seconds',
	videoRequestUnit: 'requests',
	secondsShort: 'sec',
	perMillionVideoTokens: '/ 1M video tokens',
  ...
  // Legacy model-plaza copy retained for compatibility with older components.
  modelPlaza: {
    title: 'Model Plaza',
  ...
  affiliate: {
    ...
    tips: {
      ...
      registrationReward: 'When a new user signs up with your code, you receive a {amount} registration reward.',
