export default {
    ...
    groups: {
      ...
      modelPricing: {
        ...
        longContextHint: 'Channel intervals or official preset tiers apply when either the group or account switch is enabled. Review existing OpenAI accounts after upgrading; use the account switch only for an independent opt-in.',
        add: 'Add model price'
      },
      voicePricing: {
