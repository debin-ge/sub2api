export default {
    accounts: {
      ...
      providerIdentity: {
        title: 'Provider identity and aliases',
        description: 'Available only for globally dedicated root accounts. The principal value is never persisted and approval requires another active administrator.',
        state: 'Verification state',
        identityVersion: 'Identity version',
        fingerprint: 'Principal fingerprint',
        rawNotStored: 'Only SHA-256 hashes of the Provider origin and principal are stored; the UI shows a 16-character fingerprint.',
        proposeTitle: 'Propose verification',
        principalPlaceholder: 'Stable principal ID from the Provider console',
        evidencePlaceholder: 'Redacted evidence reference, for example ticket:IDENTITY-1',
        reasonPlaceholder: 'Explain how the Provider identity was verified',
        propose: 'Submit for two-person review',
        proposed: 'Verification review submitted',
        pendingTitle: 'Pending reviews',
        proposedBy: 'Proposed by admin #{id}',
        decisionPlaceholder: 'Independent verification conclusion',
        approve: 'Approve and bind',
        reject: 'Reject',
        approved: 'Provider identity verified',
        rejected: 'Review rejected',
        revokeTitle: 'Emergency revocation',
        revokeReasonPlaceholder: 'Describe the compromise, incorrect binding, or revocation reason',
        revokeWarning: 'Revocation disables every registered alias for this principal and cannot be reversed in place.',
        revoke: 'Revoke all aliases',
        revoked: 'Provider principal revoked',
        history: 'Review history',
        loadFailed: 'Failed to load Provider identity state',
        operationFailed: 'Provider identity operation failed',
        states: { unverified: 'Unverified', verified: 'Verified', revoked: 'Revoked' },
        kinds: { account: 'Account', organization: 'Organization', project: 'Project', tenant: 'Tenant', workspace: 'Workspace' }
      },
      ...
      openai: {
		...
		endpointCapabilitiesDesc:
		  'Used by account routing. Official OpenAI endpoints require a successful read-only probe or an explicit override; custom base URLs require an explicit selection.',
		...
		videoCapabilityProbe: 'Read-only Videos capability probe',
		videoCapabilityProbeAction: 'Run probe',
		videoCapabilityProbeCompleted: 'Videos capability probe completed.',
		videoCapabilityProbeFailed: 'Videos capability probe failed.',
		videoCapabilityProbeStatus: {
		  supported: 'Supported',
		  unsupported: 'Unsupported',
		  unknown: 'Unknown',
		},
        videoDisclosureTitle: 'Video provider disclosure',
        videoDisclosureDescription:
          'Set account ownership and the maximum provider access this account permits. The system and group policies may further restrict it.',
        videoOwnerUserId: 'Exclusive owner user ID',
        videoOwnerUserIdPlaceholder: 'Optional user ID',
        videoOwnerUserIdHint:
          'Creates a globally user-dedicated account, including text, image and video scheduling. Ownership cannot be changed after creation.',
        videoOwnerUserIdInvalid: 'Exclusive owner user ID must be a positive integer.',
        videoDisclosurePolicy: 'Account disclosure limit',
        videoDisclosurePolicyHint:
          'Shared account credentials are never returned, regardless of this setting.',
        videoDisclosureInherit: 'Inherit system and group policy',
        videoDisclosureNone: 'None',
        videoDisclosureIdentity: 'Provider identity and upstream task ID',
        videoDisclosureTaskAccess: 'Task-scoped temporary access',
        videoDisclosureDedicatedCredentials: 'Dedicated account credentials',
        videoDedicatedCredentialsWarning:
          'Raw credentials require verified upstream isolation, matching global ownership and the frozen task identity version. An owner ID or a replacement API key alone is not verification.',
        accountOwnershipImmutableHint: 'Ownership is immutable. Migrate to a new isolated upstream identity instead of relabeling this account.',
        accountIsolationUnverified: 'Upstream isolation is unverified. Long-lived credentials will not be returned; enabling Videos does not verify isolation.',
        accountIsolationVerified: 'Upstream isolation verified for identity version {version}.',
        accountIsolationRevoked: 'Isolation revoked: new paid scheduling and raw credential disclosure are blocked.',
        videoDedicatedOwnerRequired:
          'Select a valid exclusive owner before enabling dedicated account credential disclosure.',
