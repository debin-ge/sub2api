    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          registrationReward: 'Registration Referral Reward',
          registrationRewardHint: 'Fixed amount granted to the inviter after a new user signs up with their referral code. 0 = disabled.',
          registrationRewardInvalid: 'Registration referral reward must be a finite number from 0 to 999999999999.9998.',
      ...
      registration: {
        ...
        emailSuffixBlacklistHint:
          "Block registration from specified email domains (for example, {'@'}nimail.cn, *.edu.cn)",
        emailSuffixBlacklistPlaceholder: "{'@'}nimail.cn, *.edu.cn",
        emailSuffixBlacklistInputHint: 'Leave empty for no restriction. Use *.edu.cn to block edu.cn and all its subdomains.',
        ...
        invitationCodeHint: 'Show the invitation code field on the registration page',
        invitationCodeRequired: 'Require Invitation Code',
        invitationCodeRequiredHint: 'When disabled, the invitation code remains available but optional',
      ...
      captcha: {
        ...
        providerGoCaptcha: 'Self-hosted Captcha'
      },
      goCaptcha: {
        description:
          'Fully self-hosted with no external service, no API keys to obtain, and reachable from mainland China. Images are generated by this server and visitor data never leaves it.',
        ...
        modeHints: {
          click: 'Click several Chinese characters in order. Strongest against automated solving; best for China-facing deployments.',
          shape: 'Click several shapes in order. As strong as text click but language-independent; recommended outside China.',
          slide: 'Drag a puzzle piece horizontally into the gap. Most familiar and lowest friction, but weakest against automated solving.',
          drag: 'Drag a puzzle piece anywhere in the image. Stronger than slide, weaker than click.',
          rotate: 'Rotate the image until it lines up. Visually distinctive, but demands precision and may lower the pass rate.'
        },
        strengthTitle: 'Resistance to blind guessing (chance of a single random attempt succeeding, order of magnitude)',
        strength: {
          click: '~1/70000',
          shape: '~1/70000',
          slide: '~1/22',
        ...
        strengthHint:
          'These numbers cover blind guessing only. Solving farms defeat every mode, so treat the captcha as a first filter and keep registration rate limits in place. A consecutive-failure cooldown is built in to backstop slide and rotate.',
        chineseOnlyWarning:
          'Text click uses Chinese characters that non-Chinese users cannot read. Choose "Shape click" for international deployments.'
      },
      tencentCaptcha: {
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for {siteName} end-user login',
      ...
      site: {
        ...
        contactQrCode: 'WeCom Support QR Code',
        uploadQrCode: 'Upload QR Code',
        contactQrCodeHint: 'Upload the WeCom customer support QR code. Once configured, users can click “Contact Support” to scan it. PNG, JPG, or WEBP; max 500KB.',
