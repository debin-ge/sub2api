export default {
  common: {
    ...
    contactSupportScanHint: 'Scan this QR code with WeChat to add our WeCom support account',
    viewSupportQrCode: 'Click to view the support QR code',
    supportQrCodeAlt: 'WeCom customer support QR code',
    add: 'Add',
  ...
  nav: {
    ...
    videoPlayground: 'Video Playground',
    usage: 'Usage',
    redeem: 'Redeem',
  ...
  auth: {
    ...
    captchaClickTitle: 'Click the targets below in order',
    captchaSlideTitle: 'Drag the slider to complete the puzzle',
    captchaDragTitle: 'Drag the puzzle piece into place',
    captchaRotateTitle: 'Rotate the image into the correct position',
    captchaConfirm: 'Confirm',
    captchaIncorrect: 'That answer was not correct. A new challenge has been loaded.',
    captchaTooManyFailures: 'Too many failed attempts. Please wait and try again later.',
    captchaUnavailable: 'Verification is temporarily unavailable. Please try again.',
    ...
    affiliateCodeInvalid: 'Invalid referral code',
    affiliateCodeDisabled: 'Referral rewards are currently disabled',
    affiliateCodeServiceUnavailable: 'Referral code validation is temporarily unavailable. Please try again',
    affiliateCodeValidating: 'Validating referral code, please wait',
    affiliateCodeInvalidCannotRegister: 'Invalid referral code. Please check it or clear the field',
    invitationSatisfiedByAffiliate: 'Your referral code satisfies the invitation requirement',
