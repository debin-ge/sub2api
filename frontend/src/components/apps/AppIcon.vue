<template>
  <!-- Claude Code — Anthropic's own tool, use Anthropic mark -->
  <svg
    v-if="icon === 'anthropic'"
    :class="sizeClass"
    viewBox="0 0 16 16"
  ...
  <!-- Codex CLI — OpenAI's own tool, use OpenAI mark -->
  <svg
    v-else-if="icon === 'openai'"
    :class="sizeClass"
    viewBox="0 0 24 24"
    fill="currentColor"
    aria-hidden="true"
  ...
  <!-- Generic application (fallback) — 2×2 rounded squares -->
  <svg
    v-else
    :class="sizeClass"
    viewBox="0 0 24 24"
...
export type AppIconKind = 'anthropic' | 'openai' | 'code' | 'app'
