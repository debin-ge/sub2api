...
const hasQuotaLimit = computed(() => {
  return props.account?.platform !== 'glm' && props.account?.platform !== 'kimi' && props.account?.platform !== 'deepseek' && props.account?.platform !== 'windsurf' && (props.account?.type === 'apikey' || props.account?.type === 'bedrock') && (
