...
const pOpts = computed(() => [{ value: '', label: t('admin.accounts.allPlatforms') }, { value: 'anthropic', label: 'Anthropic' }, { value: 'openai', label: 'OpenAI' }, { value: 'gemini', label: 'Gemini' }, { value: 'antigravity', label: 'Antigravity' }, { value: 'minimax', label: 'MiniMax' }, { value: 'glm', label: 'GLM' }, { value: 'kimi', label: 'Kimi' }, { value: 'deepseek', label: 'DeepSeek' }, { value: 'windsurf', label: 'Windsurf' }])
