        ...
        <div class="sidebar-section">
          <template v-for="item in adminNavItems" :key="item.path">
            ...
            <router-link
              ...
              :class="{ 'sidebar-link-active': isActive(item.path, item.exact), 'sidebar-link-collapsed': sidebarCollapsed }"
              :title="sidebarCollapsed ? item.label : undefined"
              :id="
...
const flagUserPurchase = () => flagPayment() !== false
...
const flagVideoPlaygroundAccess = () => canUseVideoPlayground.value
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/video-playground', label: t('nav.videoPlayground'), icon: VideoPlaygroundIcon, hideInSimpleMode: true, featureFlag: flagVideoPlaygroundAccess },
    ...
    { path: '/purchase', label: purchaseNavLabel.value, icon: RechargeSubscriptionIcon, hideInSimpleMode: true, featureFlag: flagUserPurchase },
