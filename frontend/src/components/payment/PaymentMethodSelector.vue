...
function methodIcon(type: string): string {
  ...
  if (type === 'wise') return METHOD_ICONS.wise
...
function methodSelectedClass(type: string): string {
  ...
  if (type === 'wise') return 'border-[#9FE870] bg-lime-50 text-gray-900 shadow-sm dark:border-[#9FE870] dark:bg-lime-950 dark:text-gray-100'
