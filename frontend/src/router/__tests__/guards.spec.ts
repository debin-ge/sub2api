...
describe('路由守卫逻辑', () => {
  ...
  describe('Backend Mode', () => {
    it('unauthenticated: model Radar homepage is allowed', () => {
      const authState: MockAuthState = {
        isAuthenticated: false,
        isAdmin: false,
        isSimpleMode: false,
    ...
    it('unauthenticated: /docs detail pages are allowed', () => {
      const authState: MockAuthState = {
        isAuthenticated: false,
        isAdmin: false,
        isSimpleMode: false,
    ...
    it('unauthenticated: /plaza is allowed', () => {
      const authState: MockAuthState = {
        isAuthenticated: false,
        isAdmin: false,
        isSimpleMode: false,
    ...
    it('unauthenticated: sibling paths that only start with /docs are not allowed', () => {
      const authState: MockAuthState = {
        isAuthenticated: false,
        isAdmin: false,
        isSimpleMode: false,
      ...
      const redirect = simulateGuard('/docs-admin', { requiresAuth: false }, authState)
      expect(redirect).toBe('/login')
    })
