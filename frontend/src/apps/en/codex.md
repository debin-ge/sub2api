...
# ================================================================
#  ~/.codex/config.toml · generated by {{SITE_NAME}}
#  1) This file holds NO API key. Before using, run in your shell:
#        export API_KEY="paste your sk- key here"
#     (Windows PowerShell:  $env:API_KEY="...")
#  2) Change `model` below to one listed at {{BASE_URL}}v1/models.
# ================================================================

model_provider = "{{SITE_NAME}}"
model = "gpt-5.5"                     # ← pick a real model from /v1/models
model_reasoning_effort = "medium"     # minimal | low | medium | high | xhigh

# Agent behavior (optional; keeping the defaults is fine)
...
env_key  = "API_KEY"                  # Codex reads the key from this env var
wire_api = "responses"                # keep as responses
# Enlarge these on flaky networks / long responses
