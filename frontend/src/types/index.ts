...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'minimax' | 'glm' | 'kimi' | 'deepseek' | 'windsurf'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'minimax' | 'glm' | 'kimi' | 'deepseek' | 'windsurf'
