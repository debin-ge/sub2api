...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'minimax' | 'glm' | 'kimi'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'minimax' | 'glm' | 'kimi'
