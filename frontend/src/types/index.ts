...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'minimax' | 'glm' | 'kimi' | 'deepseek' | 'windsurf' | 'opencode'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'minimax' | 'glm' | 'kimi' | 'deepseek' | 'windsurf' | 'opencode'
