...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'minimax' | 'glm' | 'kimi' | 'deepseek'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'minimax' | 'glm' | 'kimi' | 'deepseek'
