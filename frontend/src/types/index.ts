...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'minimax' | 'glm' | 'kimi' | 'deepseek' | 'windsurf' | 'opencode' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'minimax' | 'glm' | 'kimi' | 'deepseek' | 'windsurf' | 'opencode'
