                ...
                <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-700">
                  ...
                  <div v-if="form.github_oauth_enabled" class="mt-4 space-y-4">
                    <div class="rounded-lg bg-gray-50 px-3 py-2 text-xs text-gray-600 dark:bg-dark-800 dark:text-gray-300">
                      ...
                      <template v-else>
                        Setup guide: GitHub Settings → Developer settings → OAuth Apps
...
const paymentGuideHref = computed(() => "/docs");
...
> & {
  ...
  /** Write-only secret input; GET only exposes reseller_upstream_api_key_configured. */
...
const providerKeyOptions = computed(() => [
  ...
  { value: "wise", label: t("admin.settings.payment.providerWise") },
]);
