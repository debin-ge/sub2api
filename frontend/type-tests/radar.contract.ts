...
export type RadarContractAssertions = [
  ...
  Expect<Equal<DegradationLatestDTO['available_models'], DegradationModelDTO[]>>,
  Expect<Equal<DegradationLatestDTO['default_model_slugs'], string[]>>,
  Expect<Equal<DegradationLatestDTO['intelligence_index_version'], number | null>>,
  Expect<Equal<DegradationModelDTO['catalog_matches'][number]['model_id'], string>>,
  Expect<Equal<DegradationModelDTO['catalog_matches'][number]['platform'], string>>,
