...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	benchmarkService := service.NewBenchmarkService(benchmarkRepository)
	benchmarkSnapshotService := service.NewBenchmarkSnapshotService(benchmarkRepository)
	benchmarkHandler := admin.NewBenchmarkHandler(benchmarkService, benchmarkSnapshotService)
