...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	miniMaxGatewayHandler := handler.NewMiniMaxGatewayHandler(miniMaxGatewayService, gatewayService, apiKeyService, usageRecordWorkerPool, concurrencyService, configConfig)
