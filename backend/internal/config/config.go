...
// Unsigned plugins remain disabled by default; TrustedPublishers adds explicit
...
func setDefaults() {
	...
	viper.SetDefault("radar.quota_aggregator_interval_min", 6*60)
	...
	viper.SetDefault("radar.quota_stale_threshold_minutes", 12*60)
