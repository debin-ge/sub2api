...
var ProviderSet = wire.NewSet(
	...
	wire.Bind(new(service.RadarQuotaBatchReader), new(*usageLogRepository)),
	wire.Bind(new(service.BillingRecoveryUsageLogRepository), new(*usageLogRepository)),
	NewUsageBillingRepository,
	wire.Bind(new(service.UsageBillingRepository), new(*usageBillingRepository)),
	wire.Bind(new(service.DurableUsageBillingRepository), new(*usageBillingRepository)),
	wire.Bind(new(service.VideoBalanceSettlementRepository), new(*usageBillingRepository)),
	...
	NewModelPriceOverrideRepository,
	...
	NewDisposableEmailCache,
	NewMiniMaxQuotaCache,
	NewDashboardCache,
	NewEmailCache,
	NewAPIKeyEmailVerificationCache,
	NewIdentityCache,
	NewRedeemCache,
	NewUpdateCache,
	NewGeminiTokenCache,
	...
	NewNotificationEmailOutboxRepository,
	NewAPIKeyRotationRepository,
	...
	NewModelPriceOverrideCache,
	NewRadarCacheRepository,
