...
func (h *AccountHandler) GetAvailableModels(c *gin.Context) {
	...
	if h.modelCatalog == nil {
		// Keep the account dialog usable in reduced test/wiring environments.
		if !account.IsOpenAI() {
		...
		// retain the legacy local catalog below so the dialog remains usable.
		if h.accountTestService != nil {
...
func (h *AccountHandler) SyncUpstreamModels(c *gin.Context) {
	...
	catalog, err := h.accountTestService.SyncUpstreamModelCatalog(c.Request.Context(), &syncAccount)
	if err != nil {
