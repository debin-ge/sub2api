...
func TestAllowOpenAICompatibleMessagesDispatch_CNProvidersExempt(t *testing.T) {
	...
	for _, platform := range []string{service.PlatformKimi, service.PlatformZhipu, service.PlatformGLM, service.PlatformDeepseek, service.PlatformMiniMax, service.PlatformGrok} {
