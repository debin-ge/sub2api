...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	out := &APIKey{
		...
		NotificationEmail:         k.NotificationEmail,
		NotificationEmailVerified: k.NotificationEmail != nil && k.NotificationEmailVerifiedAt != nil,
		ChangeNotifyEnabled:       k.ChangeNotifyEnabled,
		RotateOnExpiry:            k.RotateOnExpiry,
