...
func TestDefaultModelIDsForCompositeIncludesAntigravityDefaults(t *testing.T) {
	antigravityIDs := service.DefaultModelCatalogIDs(service.PlatformAntigravity)
	require.NotEmpty(t, antigravityIDs)

	compositeIDs := service.DefaultModelCatalogIDs(service.PlatformComposite)
...
func TestDefaultModelIDsForPlatform_CNProvidersUseProviderDefaults(t *testing.T) {
	...
	require.Equal(t, service.DefaultMiniMaxModelIDs(), defaultModelIDsForPlatform(service.PlatformMiniMax))
}
