...
const (
	...
	CompositeRouteEndpointVideoCharacters = "video_characters"
	CompositeRouteEndpointVideoEdits      = "video_edits"
	CompositeRouteEndpointVideoExtensions = "video_extensions"
