...
const (
	...
	AffiliateRegistrationRewardAmountMax = 999_999_999_999.9998
...
func IsCNProvider(platform string) bool {
	switch CanonicalCNPlatform(platform) {
...
// CanonicalCNPlatform 把本地历史 glm 平台 ID 归一成上游 zhipu。
func CanonicalCNPlatform(platform string) string {
...
// Setting keys
const (
	SettingKeyVideoCapabilityCatalog = "video_capability_catalog_v1"
	// 注册设置
	SettingKeyRegistrationEnabled              = "registration_enabled"                // 是否开放注册
	SettingKeyEmailVerifyEnabled               = "email_verify_enabled"                // 是否开启邮件验证
	SettingKeyRegistrationEmailSuffixBlacklist = "registration_email_suffix_blacklist" // 禁止注册的邮箱域名后缀（JSON 数组）
	...
	SettingKeyInvitationCodeRequired                 = "invitation_code_required"
	SettingKeyRegistrationRateLimitPerIP             = "registration_rate_limit_per_ip"
	SettingKeyRegistrationRateLimitWindowIP          = "registration_rate_limit_window_ip"
	SettingKeyRegistrationRateLimitPerEmail          = "registration_rate_limit_per_email"
	SettingKeyRegistrationRateLimitWindowEmail       = "registration_rate_limit_window_email"
	SettingKeyRegistrationRateLimitPerEmailDomain    = "registration_rate_limit_per_email_domain"
	SettingKeyRegistrationRateLimitWindowEmailDomain = "registration_rate_limit_window_email_domain"
	...
	SettingKeyAffiliateRegistrationRewardAmount      = "affiliate_registration_reward_amount"
	...
	SettingKeyContactQRCode               = "contact_qr_code"               // 客服二维码 (base64)
	SettingKeyContactQRCodeEnabled        = "contact_qr_code_enabled"       // 是否已配置客服二维码
	...
	// SettingKeyRadarEnabled controls newly scheduled Radar background work at runtime.
