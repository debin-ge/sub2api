...
func TestModelCatalogListForAccount(t *testing.T) {
	tests := []struct {
		...
		{name: "opencode api key live", account: Account{ID: 26, Platform: PlatformOpenCodeGo, Type: AccountTypeAPIKey}, liveModels: []string{"opencode-next"}, want: []string{"opencode-next"}, wantCalls: 1},
		...
		{name: "opencode explicit mapping disables live discovery", account: Account{ID: 28, Platform: PlatformOpenCodeGo, Type: AccountTypeAPIKey, Credentials: map[string]any{"model_mapping": map[string]any{"client-opencode": "opencode-next"}}}, want: []string{"client-opencode"}},
...
func TestModelCatalogLivePolicies(t *testing.T) {
	tests := []struct {
		...
		{name: "opencode", account: Account{ID: 15, Platform: PlatformOpenCodeGo, Type: AccountTypeAPIKey}},
