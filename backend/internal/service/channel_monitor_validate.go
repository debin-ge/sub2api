...
var probeCapableProviders = map[string]struct{}{
	...
	MonitorProviderGLM:       {},
	MonitorProviderWindsurf:  {},
	// 同上：字面量 "opencode_go" 待 channel_monitor_const.go 补齐常量后收敛。
	"opencode_go": {},
}
...
//   - kimi/zhipu/deepseek/minimax coding：须识别到官方额度端点
	...
	case PlatformKimi, PlatformZhipu, PlatformDeepseek, PlatformMiniMax:
		if account.IsCodingPlan() {
			...
			case PlatformMiniMax:
				officialHosts = []string{"api.minimaxi.com", "api.minimax.io"}
			}
