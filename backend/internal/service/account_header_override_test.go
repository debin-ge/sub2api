...
func TestIsHeaderOverrideEligible(t *testing.T) {
	tests := []struct {
		...
		{"glm apikey", PlatformGLM, AccountTypeAPIKey, true},
		{"deepseek apikey", PlatformDeepseek, AccountTypeAPIKey, true},
		{"bytedance apikey", PlatformByteDance, AccountTypeAPIKey, true},
		...
		{"glm oauth", PlatformGLM, AccountTypeOAuth, false},
		{"deepseek oauth", PlatformDeepseek, AccountTypeOAuth, false},
		{"bytedance oauth", PlatformByteDance, AccountTypeOAuth, false},
