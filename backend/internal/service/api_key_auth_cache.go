...
type APIKeyAuthUserSnapshot struct {
	...
	// Pointer form is intentional: v19 must distinguish an explicit false
...
type APIKeyAuthGroupSnapshot struct {
	...
	// Pointer form is intentional: a legacy/incomplete cache snapshot must not
	// silently decode a missing authorization field as false.
	...
	// ModelsListConfig is the legacy custom /v1/models display list. It remains
	// separate from ModelAllowlist because it does not restrict dispatch.
