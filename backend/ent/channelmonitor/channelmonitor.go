...
func ProviderValidator(pr Provider) error {
	switch pr {
	case ProviderOpenai, ProviderAnthropic, ProviderGemini, ProviderGrok, ProviderMinimax, ProviderGlm, ProviderKimi, ProviderDeepseek, ProviderWindsurf, ProviderOpencode:
		return nil
	default:
