...
func init() {
	...
	userDescVipPaidEligible := userFields[20].Descriptor()
	...
	userDescVipPaidSource := userFields[22].Descriptor()
	...
	userDescVipOverrideReason := userFields[26].Descriptor()
	...
	userDescIsVip := userFields[27].Descriptor()
	...
	userDescVipEffectiveSource := userFields[29].Descriptor()
	...
	userDescRpmLimit := userFields[30].Descriptor()
