...
func init() {
	...
	// apikeyDescNotificationEmail is the schema descriptor for notification_email field.
	apikeyDescNotificationEmail := apikeyFields[11].Descriptor()
	// apikey.NotificationEmailValidator is a validator for the "notification_email" field. It is called by the builders before save.
	apikey.NotificationEmailValidator = apikeyDescNotificationEmail.Validators[0].(func(string) error)
	// apikeyDescChangeNotifyEnabled is the schema descriptor for change_notify_enabled field.
	apikeyDescChangeNotifyEnabled := apikeyFields[13].Descriptor()
	// apikey.DefaultChangeNotifyEnabled holds the default value on creation for the change_notify_enabled field.
	apikey.DefaultChangeNotifyEnabled = apikeyDescChangeNotifyEnabled.Default.(bool)
	// apikeyDescRotateOnExpiry is the schema descriptor for rotate_on_expiry field.
	apikeyDescRotateOnExpiry := apikeyFields[14].Descriptor()
	// apikey.DefaultRotateOnExpiry holds the default value on creation for the rotate_on_expiry field.
	apikey.DefaultRotateOnExpiry = apikeyDescRotateOnExpiry.Default.(bool)
	// apikeyDescValidityDurationSeconds is the schema descriptor for validity_duration_seconds field.
	apikeyDescValidityDurationSeconds := apikeyFields[15].Descriptor()
	// apikey.ValidityDurationSecondsValidator is a validator for the "validity_duration_seconds" field. It is called by the builders before save.
	apikey.ValidityDurationSecondsValidator = apikeyDescValidityDurationSeconds.Validators[0].(func(int64) error)
	// apikeyDescRotationVersion is the schema descriptor for rotation_version field.
	apikeyDescRotationVersion := apikeyFields[17].Descriptor()
	// apikey.DefaultRotationVersion holds the default value on creation for the rotation_version field.
	apikey.DefaultRotationVersion = apikeyDescRotationVersion.Default.(int64)
	// apikey.RotationVersionValidator is a validator for the "rotation_version" field. It is called by the builders before save.
	apikey.RotationVersionValidator = apikeyDescRotationVersion.Validators[0].(func(int64) error)
	...
	// accountDescOwnershipMode is the schema descriptor for ownership_mode field.
	accountDescOwnershipMode := accountFields[6].Descriptor()
	// account.DefaultOwnershipMode holds the default value on creation for the ownership_mode field.
	account.DefaultOwnershipMode = accountDescOwnershipMode.Default.(string)
	// account.OwnershipModeValidator is a validator for the "ownership_mode" field. It is called by the builders before save.
	account.OwnershipModeValidator = accountDescOwnershipMode.Validators[0].(func(string) error)
	// accountDescIsolationState is the schema descriptor for isolation_state field.
	accountDescIsolationState := accountFields[8].Descriptor()
	// account.DefaultIsolationState holds the default value on creation for the isolation_state field.
	account.DefaultIsolationState = accountDescIsolationState.Default.(string)
	// account.IsolationStateValidator is a validator for the "isolation_state" field. It is called by the builders before save.
	account.IsolationStateValidator = accountDescIsolationState.Validators[0].(func(string) error)
	// accountDescProviderIdentityVersion is the schema descriptor for provider_identity_version field.
	accountDescProviderIdentityVersion := accountFields[9].Descriptor()
	// account.DefaultProviderIdentityVersion holds the default value on creation for the provider_identity_version field.
	account.DefaultProviderIdentityVersion = accountDescProviderIdentityVersion.Default.(int64)
	// accountDescIsolationVerifiedVersion is the schema descriptor for isolation_verified_version field.
	accountDescIsolationVerifiedVersion := accountFields[10].Descriptor()
	// account.DefaultIsolationVerifiedVersion holds the default value on creation for the isolation_verified_version field.
	account.DefaultIsolationVerifiedVersion = accountDescIsolationVerifiedVersion.Default.(int64)
	// accountDescVideoDisclosurePolicy is the schema descriptor for video_disclosure_policy field.
	accountDescVideoDisclosurePolicy := accountFields[13].Descriptor()
	// account.VideoDisclosurePolicyValidator is a validator for the "video_disclosure_policy" field. It is called by the builders before save.
	account.VideoDisclosurePolicyValidator = accountDescVideoDisclosurePolicy.Validators[0].(func(string) error)
	// accountDescConcurrency is the schema descriptor for concurrency field.
	accountDescConcurrency := accountFields[16].Descriptor()
	...
	accountDescStatus := accountFields[20].Descriptor()
	// account.DefaultStatus holds the default value on creation for the status field.
	account.DefaultStatus = accountDescStatus.Default.(string)
	// account.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	account.StatusValidator = accountDescStatus.Validators[0].(func(string) error)
	// accountDescAutoPauseOnExpired is the schema descriptor for auto_pause_on_expired field.
	accountDescAutoPauseOnExpired := accountFields[24].Descriptor()
	...
	// groupDescVipOnly is the schema descriptor for vip_only field.
	groupDescVipOnly := groupFields[8].Descriptor()
	// group.DefaultVipOnly holds the default value on creation for the vip_only field.
	group.DefaultVipOnly = groupDescVipOnly.Default.(bool)
	...
	// groupDescVideoDisclosurePolicy is the schema descriptor for video_disclosure_policy field.
	groupDescVideoDisclosurePolicy := groupFields[32].Descriptor()
	// group.VideoDisclosurePolicyValidator is a validator for the "video_disclosure_policy" field. It is called by the builders before save.
	group.VideoDisclosurePolicyValidator = groupDescVideoDisclosurePolicy.Validators[0].(func(string) error)
	...
	usagelogDescUsageSource := usagelogFields[31].Descriptor()
	// usagelog.DefaultUsageSource holds the default value on creation for the usage_source field.
	usagelog.DefaultUsageSource = usagelogDescUsageSource.Default.(int8)
	// usagelogDescUsageEstimationMethod is the schema descriptor for usage_estimation_method field.
	usagelogDescUsageEstimationMethod := usagelogFields[32].Descriptor()
	// usagelog.UsageEstimationMethodValidator is a validator for the "usage_estimation_method" field. It is called by the builders before save.
	usagelog.UsageEstimationMethodValidator = usagelogDescUsageEstimationMethod.Validators[0].(func(string) error)
	// usagelogDescBillingState is the schema descriptor for billing_state field.
	usagelogDescBillingState := usagelogFields[33].Descriptor()
	// usagelog.DefaultBillingState holds the default value on creation for the billing_state field.
	usagelog.DefaultBillingState = usagelogDescBillingState.Default.(int8)
	...
	// userDescVipPaidEligible is the schema descriptor for vip_paid_eligible field.
	userDescVipPaidEligible := userFields[21].Descriptor()
	// user.DefaultVipPaidEligible holds the default value on creation for the vip_paid_eligible field.
	user.DefaultVipPaidEligible = userDescVipPaidEligible.Default.(bool)
	// userDescVipPaidSource is the schema descriptor for vip_paid_source field.
	userDescVipPaidSource := userFields[23].Descriptor()
	// user.DefaultVipPaidSource holds the default value on creation for the vip_paid_source field.
	user.DefaultVipPaidSource = userDescVipPaidSource.Default.(string)
	// user.VipPaidSourceValidator is a validator for the "vip_paid_source" field. It is called by the builders before save.
	user.VipPaidSourceValidator = userDescVipPaidSource.Validators[0].(func(string) error)
	// userDescVipOverrideReason is the schema descriptor for vip_override_reason field.
	userDescVipOverrideReason := userFields[27].Descriptor()
	// user.DefaultVipOverrideReason holds the default value on creation for the vip_override_reason field.
	user.DefaultVipOverrideReason = userDescVipOverrideReason.Default.(string)
	// userDescIsVip is the schema descriptor for is_vip field.
	userDescIsVip := userFields[28].Descriptor()
	// user.DefaultIsVip holds the default value on creation for the is_vip field.
	user.DefaultIsVip = userDescIsVip.Default.(bool)
	// userDescVipEffectiveSource is the schema descriptor for vip_effective_source field.
	userDescVipEffectiveSource := userFields[30].Descriptor()
	// user.DefaultVipEffectiveSource holds the default value on creation for the vip_effective_source field.
	user.DefaultVipEffectiveSource = userDescVipEffectiveSource.Default.(string)
	// user.VipEffectiveSourceValidator is a validator for the "vip_effective_source" field. It is called by the builders before save.
	user.VipEffectiveSourceValidator = userDescVipEffectiveSource.Validators[0].(func(string) error)
