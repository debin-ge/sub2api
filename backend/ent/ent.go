...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			paymentproviderwebhooksubscription.Table: paymentproviderwebhooksubscription.ValidColumn,
			paymentwebhookdelivery.Table:             paymentwebhookdelivery.ValidColumn,
