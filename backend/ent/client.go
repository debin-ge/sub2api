...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.PaymentProviderInstance, c.PaymentProviderWebhookSubscription,
		c.PaymentWebhookDelivery, c.PendingAuthSession, c.PromoCode, c.PromoCodeUsage,
...
type (
	hooks struct {
		...
		PaymentProviderInstance, PaymentProviderWebhookSubscription,
