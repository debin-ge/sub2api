...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "notification_email", Type: field.TypeString, Nullable: true, Size: 320},
		{Name: "notification_email_verified_at", Type: field.TypeTime, Nullable: true},
		{Name: "change_notify_enabled", Type: field.TypeBool, Default: false},
		{Name: "rotate_on_expiry", Type: field.TypeBool, Default: false},
		{Name: "validity_duration_seconds", Type: field.TypeInt64, Nullable: true},
		{Name: "last_rotated_at", Type: field.TypeTime, Nullable: true},
		{Name: "rotation_version", Type: field.TypeInt64, Default: 0},
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "ownership_mode", Type: field.TypeString, Size: 32, Default: "shared"},
		{Name: "owner_user_id", Type: field.TypeInt64, Nullable: true},
		{Name: "isolation_state", Type: field.TypeString, Size: 32, Default: "unverified"},
		{Name: "provider_identity_version", Type: field.TypeInt64, Default: 1},
		{Name: "isolation_verified_version", Type: field.TypeInt64, Default: 0},
		{Name: "provider_principal_binding_id", Type: field.TypeInt64, Nullable: true},
		{Name: "video_owner_user_id", Type: field.TypeInt64, Nullable: true},
		{Name: "video_disclosure_policy", Type: field.TypeString, Nullable: true, Size: 32},
	...
	AccountsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{AccountsColumns[6], AccountsColumns[21]},
			},
			{
				Name:    "account_priority_status",
				Unique:  false,
				Columns: []*schema.Column{AccountsColumns[21], AccountsColumns[23]},
			},
			{
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "provider", Type: field.TypeEnum, Enums: []string{"openai", "anthropic", "gemini", "grok", "antigravity", "kimi", "zhipu", "deepseek", "minimax", "glm", "windsurf", "opencode_go"}},
	...
	ModelPriceOverridesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "modelpriceoverride_platform_model_name",
				Unique:  true,
				Columns: []*schema.Column{ModelPriceOverridesColumns[3], ModelPriceOverridesColumns[4]},
			},
		},
	}
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "usage_source", Type: field.TypeInt8, Default: 0},
		{Name: "usage_estimation_method", Type: field.TypeString, Nullable: true, Size: 16},
		{Name: "billing_state", Type: field.TypeInt8, Default: 0},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "vip_paid_eligible", Type: field.TypeBool, Default: false},
		{Name: "vip_paid_eligible_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "vip_paid_source", Type: field.TypeString, Size: 20, Default: ""},
		{Name: "vip_manual_override", Type: field.TypeBool, Nullable: true},
		{Name: "vip_override_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "vip_override_by", Type: field.TypeInt64, Nullable: true},
		{Name: "vip_override_reason", Type: field.TypeString, Default: "", SchemaType: map[string]string{"postgres": "text"}},
		{Name: "is_vip", Type: field.TypeBool, Default: false},
		{Name: "vip_granted_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "vip_effective_source", Type: field.TypeString, Size: 20, Default: ""},
		{Name: "rpm_limit", Type: field.TypeInt, Default: 0},
	}
